  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-red-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Are love calculators accurate?","acceptedAnswer":{"@type":"Answer","text":"No, love calculators are purely for entertainment and have no scientific accuracy. They use arbitrary algorithms based on names or birthdates and cannot predict actual romantic compatibility. Real compatibility depends on values, communication, emotional intelligence, and many other factors that a simple name-based calculator cannot assess."}},{"@type":"Question","name":"Can names really determine compatibility?","acceptedAnswer":{"@type":"Answer","text":"No. While names are an important part of our identity, they have no inherent power to determine romantic compatibility. Relationship success depends on personality, values, communication skills, emotional maturity, and how partners treat each other - none of which can be derived from names alone."}},{"@type":"Question","name":"What if I get a low compatibility score?","acceptedAnswer":{"@type":"Answer","text":"Don\'t worry! Love calculator results are random and meaningless. A low score has absolutely no bearing on your real relationship potential. Many successful, loving relationships would score poorly on these arbitrary tests. Focus on how you actually feel, how you communicate, and whether you share important values."}},{"@type":"Question","name":"How can I know if someone is right for me?","acceptedAnswer":{"@type":"Answer","text":"Real compatibility requires time, communication, and shared experiences. Pay attention to: How do you resolve conflicts? Do you share core values? Can you be yourself around them? Do they support your growth? Are you emotionally safe? Do you have good communication? Trust your feelings and observations over any calculator or test."}},{"@type":"Question","name":"What makes a relationship last?","acceptedAnswer":{"@type":"Answer","text":"Research shows lasting relationships share: mutual respect, good communication, ability to resolve conflicts constructively, emotional support, shared values and goals, trust and loyalty, maintaining positive interactions, and commitment to growth. Physical attraction initiates relationships, but these deeper factors sustain them."}},{"@type":"Question","name":"Do opposites attract or do similar people work better?","acceptedAnswer":{"@type":"Answer","text":"Research generally supports \"birds of a feather\" - couples with similar values, backgrounds, interests, and personalities tend to have higher satisfaction. However, some differences can be complementary (like one partner being more outgoing while the other is reflective). The key is having similar core values even if personalities differ."}},{"@type":"Question","name":"Is there such a thing as a soulmate?","acceptedAnswer":{"@type":"Answer","text":"The \"soulmate myth\" - that there\'s one perfect person destined for you - is unsupported by research and can actually harm relationships by setting unrealistic expectations. Successful relationships are built through choice, effort, and compatibility, not magical destiny. Many potential good matches exist; what matters is choosing to build a strong relationship with commitment and work."}},{"@type":"Question","name":"Can love calculators be harmful?","acceptedAnswer":{"@type":"Answer","text":"When taken seriously, they can be. Some people might end promising relationships or avoid pursuing someone based on a low \"compatibility\" score. Young people especially might take these seriously. Always remember: these are entertainment only. Real relationship decisions should be based on your actual experiences, feelings, and observations - never on arbitrary online calculators."}}]}' }}
      />
      <Navigation />
