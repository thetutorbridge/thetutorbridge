  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-gray-100">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I add feet and inches with fractions?","acceptedAnswer":{"@type":"Answer","text":"To add feet and inches with fractions, first convert both measurements to total inches (multiply feet by 12 and add inches). Add the two total inch values together. Then divide the result by 12 to get feet (the whole number) and the remainder is the inches. For fractions, convert to decimals (e.g., 3/4 = 0.75), perform the calculation, then convert back to the nearest fraction if needed."}},{"@type":"Question","name":"Can I enter just inches or just feet?","acceptedAnswer":{"@type":"Answer","text":"Yes! You can leave either the feet or inches field blank. If you\'re measuring something that\'s only in inches (like 61 3/4 inches), just enter that in the inches field and leave feet blank. If you have a measurement that\'s only whole feet with no extra inches, enter the feet and leave inches blank or enter 0."}},{"@type":"Question","name":"What fractions can I use?","acceptedAnswer":{"@type":"Answer","text":"You can use any fraction, but common carpentry fractions work best: 1/2, 1/4, 3/4, 1/8, 3/8, 5/8, 7/8, and 1/16. You can also use mixed numbers like \'7 3/8\' or \'61 3/4\'. The calculator will convert these to decimals, perform the calculation, and convert back to fractional form in the answer."}},{"@type":"Question","name":"How accurate is the calculator?","acceptedAnswer":{"@type":"Answer","text":"The calculator performs all calculations with high precision (up to 10 decimal places internally) and displays results to 4 decimal places for feet and 3 decimal places for inches. Fractions are approximated to the nearest 1/8 inch for practical use in construction and carpentry, which is the standard precision for most tape measures."}},{"@type":"Question","name":"Why do I get negative results in subtraction?","acceptedAnswer":{"@type":"Answer","text":"You\'ll get a negative result when subtracting a larger measurement from a smaller one. For example, 5 ft 3 in minus 8 ft 7 in = -3 ft -4 in. This indicates the second measurement is larger by that amount. In practical applications, you may need to reverse the order of subtraction or interpret the negative result as a deficit or shortage."}},{"@type":"Question","name":"When would I multiply or divide feet and inches?","acceptedAnswer":{"@type":"Answer","text":"Multiplication is useful when calculating total lengths of multiple identical pieces (e.g., 5 boards each 8 ft 3 in long). Division is helpful for splitting measurements into equal parts (e.g., dividing a 10 ft board into 3 equal pieces) or calculating unit rates. Note that multiplication and division results may need interpretation based on your specific application."}},{"@type":"Question","name":"How do I convert between feet and inches?","acceptedAnswer":{"@type":"Answer","text":"To convert feet to inches, multiply by 12 (e.g., 5 ft = 5 × 12 = 60 inches). To convert inches to feet, divide by 12 (e.g., 36 inches = 36 ÷ 12 = 3 feet). For mixed measurements like 5 ft 8 in, convert the feet to inches first (5 × 12 = 60), then add the inches (60 + 8 = 68 total inches)."}},{"@type":"Question","name":"What if my inches exceed 12?","acceptedAnswer":{"@type":"Answer","text":"The calculator automatically handles inches greater than 12 by converting them to feet. For example, if you enter 0 feet and 25 inches, the calculator will show the result as 2 ft 1 in (since 25 ÷ 12 = 2 with remainder 1). This is helpful when you\'re working with measurements from a tape measure that shows total inches."}}]}' }}
      />
      <Navigation />
