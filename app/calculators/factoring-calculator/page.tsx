  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-gray-100">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the difference between factors and multiples?","acceptedAnswer":{"@type":"Answer","text":"Factors divide into a number evenly (12 ÷ 3 = 4, so 3 is a factor of 12), while multiples are the result of multiplying a number by whole numbers (12 × 3 = 36, so 36 is a multiple of 12). Factors are smaller than or equal to the number, while multiples are larger than or equal to the number."}},{"@type":"Question","name":"Can negative numbers have factors?","acceptedAnswer":{"@type":"Answer","text":"Yes, negative numbers have factors. The factors of -12 include both positive and negative divisors: ±1, ±2, ±3, ±4, ±6, ±12. However, when we talk about factors in elementary mathematics, we typically refer only to positive factors for simplicity. This calculator shows positive factors."}},{"@type":"Question","name":"What is the fastest way to find all factors?","acceptedAnswer":{"@type":"Answer","text":"The most efficient method is to test only numbers up to the square root of the number. For example, for 100, you only need to test 1 through 10. When you find a factor (like 2), you automatically know its pair (100 ÷ 2 = 50). This cuts the work roughly in half and is the method used by this calculator."}},{"@type":"Question","name":"How many factors does a prime number have?","acceptedAnswer":{"@type":"Answer","text":"A prime number has exactly 2 factors: 1 and itself. This is the defining characteristic of prime numbers. For example, 7 has only two factors (1 and 7), 13 has only two factors (1 and 13), and 29 has only two factors (1 and 29). The number 1 is special—it has only one factor (itself) and is neither prime nor composite."}},{"@type":"Question","name":"Why do perfect squares have an odd number of factors?","acceptedAnswer":{"@type":"Answer","text":"Perfect squares have an odd number of factors because one factor pairs with itself. For example, 36 = 6 × 6. All other factors come in pairs (1 and 36, 2 and 18, 3 and 12, 4 and 9), but 6 pairs with itself, giving 36 a total of 9 factors (an odd number). This pattern applies to all perfect squares."}},{"@type":"Question","name":"What number has the most factors?","acceptedAnswer":{"@type":"Answer","text":"There\'s no single answer—larger numbers tend to have more factors, but it depends on the number\'s prime factorization. Numbers with many small prime factors have more divisors. For example, 120 has 16 factors, and 840 has 32 factors. Highly composite numbers are defined as having more factors than any smaller positive integer."}},{"@type":"Question","name":"Can 0 or 1 have factors?","acceptedAnswer":{"@type":"Answer","text":"Zero is divisible by every number (except zero itself), so it has infinitely many factors. The number 1 has exactly one factor: itself. Because 1 only has one factor rather than two or more, it is classified as neither prime nor composite—it\'s a special case called a unit in number theory."}}]}' }}
      />
      <Navigation />
