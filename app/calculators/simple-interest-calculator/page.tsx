  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-green-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the difference between simple and compound interest?","acceptedAnswer":{"@type":"Answer","text":"Simple interest is calculated only on the principal amount, while compound interest is calculated on both the principal and accumulated interest. Simple interest grows linearly, while compound interest grows exponentially over time."}},{"@type":"Question","name":"How do I convert monthly interest rate to annual?","acceptedAnswer":{"@type":"Answer","text":"To convert a monthly interest rate to an annual rate, multiply it by 12. For example, 1% per month equals 12% per year. However, note that this is different from compound interest calculations."}},{"@type":"Question","name":"Can simple interest be negative?","acceptedAnswer":{"@type":"Answer","text":"In standard financial contexts, simple interest is not negative. However, in some theoretical scenarios or when dealing with debt reductions, you might see negative interest rates, but this is uncommon in simple interest calculations."}},{"@type":"Question","name":"Is simple interest better than compound interest?","acceptedAnswer":{"@type":"Answer","text":"It depends on your perspective. For borrowers, simple interest is better as it results in lower total interest paid. For investors, compound interest is better as it generates higher returns over time. Simple interest is easier to calculate and understand."}},{"@type":"Question","name":"How accurate is this simple interest calculator?","acceptedAnswer":{"@type":"Answer","text":"This calculator uses precise mathematical formulas and provides results accurate to several decimal places. The step-by-step solutions show exactly how calculations are performed, ensuring transparency and accuracy."}},{"@type":"Question","name":"What if my time period is in months or days?","acceptedAnswer":{"@type":"Answer","text":"The calculator automatically converts your time input to years based on the unit you select. You can enter time in years, months, or days, and the calculator will handle the conversion (months ÷ 12, days ÷ 365)."}}]}' }}
      />
      <Navigation />
