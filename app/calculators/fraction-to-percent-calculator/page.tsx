  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-red-50 via-pink-50 to-rose-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do you convert a fraction to a percentage?","acceptedAnswer":{"@type":"Answer","text":"To convert a fraction to a percentage, divide the numerator (top number) by the denominator (bottom number) to get a decimal, then multiply the decimal by 100. Finally, add the percent sign (%). For example: 3/4 = 0.75 × 100 = 75%. This two-step process works for any fraction."}},{"@type":"Question","name":"Why do we multiply by 100 to get a percentage?","acceptedAnswer":{"@type":"Answer","text":"The word \'percent\' means \'per hundred\' or \'out of 100.\' When you multiply a decimal by 100, you\'re converting it to an equivalent number of parts per 100. For example, 0.5 means 5 parts out of 10, and 0.5 × 100 = 50, meaning 50 parts out of 100, or 50%. Multiplying by 100 shifts the decimal point two places to the right."}},{"@type":"Question","name":"Can a fraction be more than 100%?","acceptedAnswer":{"@type":"Answer","text":"Yes! When the numerator is larger than the denominator (improper fraction), the percentage will be greater than 100%. For example, 5/4 = 1.25 × 100 = 125%. This means 5 parts out of 4, which is more than one whole. Improper fractions and mixed numbers always convert to percentages above 100%."}},{"@type":"Question","name":"How do you convert a mixed number to a percentage?","acceptedAnswer":{"@type":"Answer","text":"First convert the mixed number to an improper fraction, then follow the normal conversion process. For example, 2 1/4: Convert to improper fraction: (2 × 4 + 1)/4 = 9/4. Then divide: 9 ÷ 4 = 2.25. Multiply by 100: 2.25 × 100 = 225%. Alternatively, the whole number part is already 100% each, so 2 1/4 = 200% + 25% = 225%."}},{"@type":"Question","name":"What if my fraction has a repeating decimal?","acceptedAnswer":{"@type":"Answer","text":"Some fractions like 1/3 produce repeating decimals (0.3333...). In these cases, round to your desired precision. For example, 1/3 = 0.333... × 100 = 33.33% (rounded to 2 decimal places) or 33.333% (rounded to 3 decimal places). Our calculator lets you choose how many decimal places to round to. Common repeating fractions include thirds (1/3, 2/3), sixths, ninths, and sevenths."}},{"@type":"Question","name":"How do you convert a percentage back to a fraction?","acceptedAnswer":{"@type":"Answer","text":"To convert a percentage to a fraction, write the percentage as a fraction over 100, then simplify. For example, 75% = 75/100 = 3/4 (divide both by 25). For percentages with decimals like 12.5%, first write as 12.5/100, then multiply both numerator and denominator by 10 to eliminate the decimal: 125/1000 = 1/8 (simplified)."}},{"@type":"Question","name":"What\'s the easiest way to do this mentally?","acceptedAnswer":{"@type":"Answer","text":"For mental math, try these shortcuts: (1) If denominator is 2, multiply numerator by 50. (2) If denominator is 4, multiply numerator by 25. (3) If denominator is 5, multiply numerator by 20. (4) If denominator is 10, multiply numerator by 10. (5) Memorize common fractions: 1/2=50%, 1/4=25%, 3/4=75%, 1/3≈33%, 2/3≈67%, 1/5=20%."}},{"@type":"Question","name":"When should I use fractions vs percentages?","acceptedAnswer":{"@type":"Answer","text":"Use fractions for exact values and mathematical operations (adding, subtracting, multiplying). Use percentages for comparisons, describing portions in everyday contexts, and data presentation. For example, in recipes use fractions (1/2 cup), but for discounts use percentages (25% off). Percentages are often easier for people to understand and compare quickly."}}]}' }}
      />
      <Navigation />
