  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Q: How accurate is this grade calculator?","acceptedAnswer":{"@type":"Answer","text":"A: This calculator is 100% accurate when you input the correct information. It uses standard weighted average formulas that are universally accepted in education. However, your actual grade depends on your instructor entering the same data correctly into their gradebook. Always verify with your official course grade."}},{"@type":"Question","name":"Q: What if my category weights don&apos;t add up to 100%?","acceptedAnswer":{"@type":"Answer","text":"A: The calculator will still work, but for the most accurate results, weights should total 100%. If you&apos;re mid-semester and haven&apos;t completed all categories, only enter weights for graded categories. The calculator shows what percentage of the total grade has been calculated."}},{"@type":"Question","name":"Q: Can I use this calculator for college and high school?","acceptedAnswer":{"@type":"Answer","text":"A: Yes! This grade calculator works for any educational level - elementary school, middle school, high school, college, university, or graduate programs. The weighted average calculation method is the same across all education levels."}},{"@type":"Question","name":"Q: What&apos;s the difference between weighted and unweighted grades?","acceptedAnswer":{"@type":"Answer","text":"A: An unweighted grade treats all assignments equally (simple average). A weighted grade gives different importance to different categories - for example, tests might count for 40% while homework counts for 20%. Most courses use weighted grades because not all assignments should have equal impact."}},{"@type":"Question","name":"Q: How do I find my course category weights?","acceptedAnswer":{"@type":"Answer","text":"A: Check your course syllabus - it should list the grading breakdown. You can also find this information in your school&apos;s online portal, ask your instructor directly, or check any grading policy documents provided at the start of the course."}},{"@type":"Question","name":"Q: Can I calculate multiple courses at once?","acceptedAnswer":{"@type":"Answer","text":"A: This calculator focuses on one course at a time for detailed accuracy. For GPA calculations across multiple courses, use our College GPA Calculator or High School GPA Calculator."}},{"@type":"Question","name":"Q: What if I get a negative result for &quot;What Grade Do I Need?&quot;","acceptedAnswer":{"@type":"Answer","text":"A: A negative result means you&apos;ve already exceeded your desired grade! You could theoretically score 0% on the final exam and still achieve your target. However, it&apos;s still wise to study and perform well to maintain your strong grade."}},{"@type":"Question","name":"Q: Does this calculator account for extra credit?","acceptedAnswer":{"@type":"Answer","text":"A: Yes! If you&apos;ve earned extra credit, add those points to your &quot;Earned Points&quot; for the relevant category. For example, if you earned 105 out of 100 possible homework points (including extra credit), enter 105 in the earned points field."}}]}' }}
      />
      <Navigation />
