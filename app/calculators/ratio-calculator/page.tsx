  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the difference between a ratio and a fraction?","acceptedAnswer":{"@type":"Answer","text":"While ratios and fractions are closely related, they have different meanings. A fraction represents a part of a whole, while a ratio compares two separate quantities. For example, 3/4 as a fraction means 3 parts out of 4 total parts. As a ratio (3 : 4), it means for every 3 of one thing, there are 4 of another. However, ratios can be written as fractions mathematically."}},{"@type":"Question","name":"How do I know if two ratios are equivalent?","acceptedAnswer":{"@type":"Answer","text":"Use cross multiplication: for A : B = C : D to be true, A × D must equal B × C. Alternatively, simplify both ratios to their lowest terms—if they simplify to the same ratio, they\'re equivalent. Our calculator above does both checks automatically."}},{"@type":"Question","name":"Can ratios be greater than 1?","acceptedAnswer":{"@type":"Answer","text":"Yes! Ratios can be any positive number. A ratio of 5 : 2 means the first quantity is 2.5 times the second. Ratios greater than 1 (when written as fractions) simply mean the first quantity is larger than the second."}},{"@type":"Question","name":"What does it mean to simplify a ratio?","acceptedAnswer":{"@type":"Answer","text":"Simplifying a ratio means reducing it to its smallest whole number terms by dividing both parts by their greatest common divisor (GCD). For example, 10 : 15 simplifies to 2 : 3 by dividing both by 5. The simplified ratio represents the same relationship but with smaller, easier-to-work-with numbers."}},{"@type":"Question","name":"How do I find a missing value in a proportion?","acceptedAnswer":{"@type":"Answer","text":"Use cross multiplication. If you have A : B = C : x and need to find x, cross multiply: A × x = B × C, then solve for x by dividing: x = (B × C) / A. For example, in 3 : 4 = 6 : x, we get 3x = 24, so x = 8."}},{"@type":"Question","name":"Why is order important in ratios?","acceptedAnswer":{"@type":"Answer","text":"The order in a ratio matters because it specifies which quantity comes first. A ratio of boys to girls of 2 : 3 is different from a ratio of girls to boys of 3 : 2. Always make sure you understand what the first and second quantities represent in the context of the problem."}},{"@type":"Question","name":"Can ratios have decimal numbers?","acceptedAnswer":{"@type":"Answer","text":"While ratios can technically involve decimals (like 2.5 : 3.7), it\'s standard practice to convert them to whole numbers for simplicity. Multiply both terms by the same power of 10 to eliminate decimals. For example, 2.5 : 3.7 becomes 25 : 37 when multiplied by 10."}},{"@type":"Question","name":"How are ratios used in real life?","acceptedAnswer":{"@type":"Answer","text":"Ratios appear everywhere: cooking recipes (ingredient proportions), map scales (1:50,000), finance (debt-to-equity ratios), photography (aspect ratios like 16:9), medicine (dosage calculations), construction (concrete mix ratios), and sports statistics (win-loss ratios). Understanding ratios is essential for many practical applications."}}]}' }}
      />
      <Navigation />
