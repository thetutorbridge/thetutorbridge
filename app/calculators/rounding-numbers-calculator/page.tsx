  ...
  const renderNumberWithHighlights = (numStr: string, targetIdx: number, nextIdx: number) => {
    return (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What does it mean to round to the nearest tenth?","acceptedAnswer":{"@type":"Answer","text":"Rounding to the nearest tenth means rounding to one decimal place. You look at the digit in the tenths place (first digit after the decimal) and the digit in the hundredths place (second digit after the decimal) to determine whether to round up or down. For example, 3.47 rounds to 3.5, while 3.43 rounds to 3.4."}},{"@type":"Question","name":"Why do we round 5 up instead of down?","acceptedAnswer":{"@type":"Answer","text":"The standard rounding convention (round half up) treats 5 as the midpoint and rounds it upward. This is the most commonly used method in education, finance, and general mathematics. While other rounding methods exist (like round half to even), the \'5 rounds up\' rule is the accepted standard for most applications and ensures consistency across calculations."}},{"@type":"Question","name":"What\'s the difference between rounding and truncating?","acceptedAnswer":{"@type":"Answer","text":"Rounding considers the digits being removed and adjusts the last remaining digit accordingly, while truncating simply cuts off digits without any adjustment. For example, truncating 3.89 to one decimal gives 3.8, but rounding 3.89 to one decimal gives 3.9. Rounding provides a more accurate approximation of the original value."}},{"@type":"Question","name":"Can you round negative numbers?","acceptedAnswer":{"@type":"Answer","text":"Yes, the same rounding rules apply to negative numbers. When rounding -3.7 to ones, you look at the 7 (which is ≥ 5), so you round away from zero to -4. Similarly, -3.4 rounds to -3. The key is that \'rounding up\' for negative numbers means moving away from zero (becoming more negative), not toward positive numbers."}},{"@type":"Question","name":"What happens when you round 99.9 to the nearest whole number?","acceptedAnswer":{"@type":"Answer","text":"When you round 99.9 to the nearest whole number, you look at the tenths digit (9), which is ≥ 5, so you round up. The 99 becomes 100. This demonstrates that rounding can change the number of digits in your answer, which is perfectly normal. The answer is 100."}},{"@type":"Question","name":"How do you round money amounts?","acceptedAnswer":{"@type":"Answer","text":"Money is typically rounded to the hundredths place (cents) since most currencies have two decimal places. For example, $45.678 becomes $45.68, and $32.342 becomes $32.34. Some countries without cent denominations round to the nearest nickel (0.05) or to the nearest whole currency unit."}},{"@type":"Question","name":"What is the difference between rounding to decimal places and significant figures?","acceptedAnswer":{"@type":"Answer","text":"Rounding to decimal places counts positions after the decimal point (e.g., 3.456 to two decimal places is 3.46). Rounding to significant figures counts all meaningful digits from the first non-zero digit (e.g., 3.456 to two significant figures is 3.5, and 0.003456 to two significant figures is 0.0035). Our calculator focuses on decimal place rounding, which is more common in everyday applications."}},{"@type":"Question","name":"Should I round during calculations or only at the end?","acceptedAnswer":{"@type":"Answer","text":"It\'s best to keep full precision throughout your calculations and only round the final answer. Rounding intermediate steps can introduce rounding errors that compound, leading to less accurate final results. Modern calculators and computers maintain high precision internally for this reason."}}]}' }}
      />
