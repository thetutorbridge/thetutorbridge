  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I add mixed numbers with different denominators?","acceptedAnswer":{"@type":"Answer","text":"Method 1: Add whole numbers separately, then add fractions by finding the LCD (Least Common Denominator). For example, 2 ¾ + 1 ½: Add wholes (2+1=3), find LCD of 4 and 2 (which is 4), convert ½ to 2/4, add fractions (¾ + 2/4 = 5/4 = 1¼), then combine (3 + 1¼ = 4¼)."}},{"@type":"Question","name":"What\'s the easiest way to multiply mixed numbers?","acceptedAnswer":{"@type":"Answer","text":"Always convert to improper fractions first, then multiply numerators together and denominators together. For example: 2 ½ × 1 ⅓ = 5/2 × 4/3 = (5×4)/(2×3) = 20/6 = 10/3 = 3 ⅓. Never try to multiply mixed numbers directly without converting first."}},{"@type":"Question","name":"How do I convert a mixed number to an improper fraction?","acceptedAnswer":{"@type":"Answer","text":"Use the formula: (whole number × denominator) + numerator, keep the same denominator. Example: 2 ¾ = (2 × 4 + 3) / 4 = (8 + 3) / 4 = 11/4. For negative numbers, apply the negative sign to the final result: -2 ¾ = -11/4."}},{"@type":"Question","name":"Why do I need to find the LCD for addition and subtraction?","acceptedAnswer":{"@type":"Answer","text":"You can only add or subtract fractions with the same denominator. The LCD (Least Common Denominator) is the smallest number that both denominators divide into evenly. For example, to add ¾ + ⅔, find LCD of 4 and 3 (which is 12), convert to 9/12 + 8/12 = 17/12 = 1 5/12."}},{"@type":"Question","name":"Can I enter decimals in this calculator?","acceptedAnswer":{"@type":"Answer","text":"Yes! Enter decimals like 1.75 or 0.5 and the calculator automatically converts them to fractions. For example, 1.75 becomes 1 ¾ and 0.5 becomes ½. This is useful when you have decimal measurements that need to be calculated with fractions."}},{"@type":"Question","name":"How do I simplify an improper fraction back to a mixed number?","acceptedAnswer":{"@type":"Answer","text":"Divide the numerator by the denominator. The quotient is the whole number, the remainder is the new numerator, and the denominator stays the same. Example: 17/4 → 17 ÷ 4 = 4 remainder 1, so 17/4 = 4 ¼."}},{"@type":"Question","name":"What if my answer is an improper fraction?","acceptedAnswer":{"@type":"Answer","text":"The calculator automatically converts improper fractions to mixed numbers in the final answer. However, if the improper fraction is already in lowest terms (like 5/4), it will show as a mixed number (1 ¼). In mathematics, either form is correct, but mixed numbers are usually preferred for final answers."}},{"@type":"Question","name":"How do I handle negative mixed numbers?","acceptedAnswer":{"@type":"Answer","text":"Put a minus sign before the number (e.g., -2 ¾). When calculating, the negative applies to the entire mixed number. For example: -2 ¾ = -11/4 (not -2 and ¾ separately). The calculator handles all negative number operations automatically."}}]}' }}
      />
      <Navigation />
