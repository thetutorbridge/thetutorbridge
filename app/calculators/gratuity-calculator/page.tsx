  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is gratuity and who is eligible?","acceptedAnswer":{"@type":"Answer","text":"Gratuity is a lump sum payment made by employers to employees as a token of appreciation for services rendered. You\'re eligible if you\'ve completed 5 years of continuous service (or earlier in case of death/disability). Governed by Payment of Gratuity Act 1972 for organizations with 10+ employees."}},{"@type":"Question","name":"How is gratuity calculated?","acceptedAnswer":{"@type":"Answer","text":"Formula: (Years of Service × Last Drawn Salary × 15) ÷ 26. Last drawn salary includes Basic + DA only (not HRA, allowances, or bonus). For example, 10 years service with ₹50,000 salary = (10 × 50,000 × 15) ÷ 26 = ₹2,88,462 gratuity."}},{"@type":"Question","name":"What is the maximum gratuity amount?","acceptedAnswer":{"@type":"Answer","text":"The maximum gratuity limit is ₹20 lakh as per the latest amendment (increased from ₹10 lakh in 2010). Any gratuity amount exceeding this limit is considered \"ex gratia\" payment and is fully taxable. This cap applies to private sector employees only."}},{"@type":"Question","name":"Is gratuity taxable?","acceptedAnswer":{"@type":"Answer","text":"Tax exemption under Section 10(10): Government employees get full exemption. Private sector employees get exemption up to ₹20 lakh or actual gratuity received, whichever is lower. Amount above ₹20 lakh is taxable as salary. For non-covered employees, minimum of actual, ₹20L, or 15 days salary × years worked is exempt."}},{"@type":"Question","name":"Can I get gratuity if I resign before 5 years?","acceptedAnswer":{"@type":"Answer","text":"Generally no. Minimum 5 years of continuous service is mandatory for gratuity eligibility. However, exceptions exist for: Death, disability/accident causing termination, or contractual agreements providing gratuity for shorter tenure. Some companies offer ex-gratia payments voluntarily."}},{"@type":"Question","name":"How are partial years calculated for gratuity?","acceptedAnswer":{"@type":"Answer","text":"Partial years are rounded to nearest full year. If you worked 6 months or more in a year, it counts as 1 full year. Less than 6 months is ignored. For example, 10 years 7 months = 11 years for gratuity calculation. 10 years 4 months = 10 years only."}},{"@type":"Question","name":"When should gratuity be paid?","acceptedAnswer":{"@type":"Answer","text":"Gratuity must be paid within 30 days of becoming due (resignation, retirement, death, or disablement). If delayed beyond 30 days, employer must pay interest @ 10% p.a. Employee can file complaint with Controlling Authority if payment is delayed or disputed."}},{"@type":"Question","name":"Does changing jobs affect gratuity?","acceptedAnswer":{"@type":"Answer","text":"Yes, significantly. You lose gratuity if you resign before 5 years. Service period doesn\'t carry forward to new employer. If you\'ve completed 5+ years, you get gratuity from current employer when leaving. To maximize gratuity, complete major milestones (5, 10, 15, 20 years) before job changes."}}]}' }}
      />
      <Navigation />
