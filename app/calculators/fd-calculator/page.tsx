...
import { PiggyBank, Home, ArrowRight, TrendingUp, Shield, Clock, Calculator, BookOpen } from 'lucide-react';
          ...
          <section className="text-center py-12">
            <div className="bg-gradient-to-r from-[#1A3D7C] via-[#2BAE66] to-[#1A3D7C] text-white p-12 rounded-2xl shadow-xl">
              ...
              <p className="text-lg md:text-xl mb-8 text-white/90 max-w-3xl mx-auto leading-relaxed">
                Our expert tutors can help you master compound interest, maturity calculations, and financial mathematics. Get personalized one-on-one guidance.
              </p>
