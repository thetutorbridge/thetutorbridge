  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I convert numbers to words for check writing?","acceptedAnswer":{"@type":"Answer","text":"Enter your check amount (e.g., 1234.56), select \"Check Writing\" format, and click Calculate. The converter outputs proper check format like \"One thousand two hundred thirty-four and 56/100\". This format is universally accepted by all banks for check processing."}},{"@type":"Question","name":"What\'s the difference between Words, Currency, and Check Writing formats?","acceptedAnswer":{"@type":"Answer","text":"Words gives plain text (e.g., \"one hundred\"). Currency adds rupees/paise with \"only\" suffix (e.g., \"one hundred rupees only\"). Check Writing uses fraction format for cents/paise (e.g., \"One hundred and 00/100\"). Use Words for general text, Currency for invoices/receipts, and Check Writing specifically for bank checks."}},{"@type":"Question","name":"Can I convert decimal numbers like 123.45?","acceptedAnswer":{"@type":"Answer","text":"Yes! For Words format, decimals convert as \"point five four\". For Currency format, it becomes \"one hundred twenty-three rupees and forty-five paise\". For Check Writing, it shows \"One hundred twenty-three and 45/100\". The converter handles up to 2 decimal places for currency."}},{"@type":"Question","name":"What\'s the maximum number I can convert?","acceptedAnswer":{"@type":"Answer","text":"Our converter supports numbers up to 999,999,999,999 (999 billion). This covers virtually all practical use cases from personal checks to large business contracts. Numbers are converted with proper place value notation including thousands, millions, and billions."}},{"@type":"Question","name":"When should I use Title Case vs UPPERCASE vs lowercase?","acceptedAnswer":{"@type":"Answer","text":"Use Title Case for formal business documents and legal contracts. Use lowercase for casual writing or when matching document style. Use UPPERCASE for emphasis or when required by specific forms. Note: Check Writing format automatically uses proper capitalization (first letter uppercase) regardless of your selection."}},{"@type":"Question","name":"Is this converter accurate for legal and financial documents?","acceptedAnswer":{"@type":"Answer","text":"Yes, our converter follows standard English number-to-word rules and proper formatting conventions. It correctly handles hyphens in compound numbers (e.g., \"twenty-one\"), place values, and currency formatting. However, always double-check important documents and consult with legal/financial advisors for critical transactions."}},{"@type":"Question","name":"How do I spell out numbers in Indian numbering system vs International?","acceptedAnswer":{"@type":"Answer","text":"Our converter uses the International numbering system (thousands, millions, billions) which is standard for English. For example, 100000 = \"one hundred thousand\" (not \"one lakh\"). This format is universally accepted in international business, banking, and legal documents."}},{"@type":"Question","name":"Can I use this for writing demand drafts (DD)?","acceptedAnswer":{"@type":"Answer","text":"Absolutely! Use the Currency format for demand drafts. Enter the DD amount, select \"Currency\" and \"Title Case\", and you\'ll get the proper format: \"Five Thousand Rupees Only\". Banks accept this format for DDs, pay orders, and banker\'s checks."}}]}' }}
      />
      <Navigation />
