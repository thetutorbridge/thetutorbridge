  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-teal-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What\'s the difference between mean and median?","acceptedAnswer":{"@type":"Answer","text":"Mean is the arithmetic average (sum ÷ count), while median is the middle value when data is ordered. Mean is affected by extreme values (outliers), but median is resistant to them. Use mean for symmetric data and median for skewed data or data with outliers."}},{"@type":"Question","name":"What are outliers and why are they important?","acceptedAnswer":{"@type":"Answer","text":"Outliers are data points that are significantly different from other observations. They\'re identified using the IQR method: values below Q₁ − 1.5×IQR or above Q₃ + 1.5×IQR. Outliers can indicate data errors, special cases, or important anomalies worth investigating."}},{"@type":"Question","name":"What is the interquartile range (IQR)?","acceptedAnswer":{"@type":"Answer","text":"IQR is the range of the middle 50% of the data, calculated as Q₃ − Q₁. It measures the spread of the central portion of the data and is resistant to outliers, making it a robust measure of variability. A smaller IQR indicates data is more clustered around the median."}},{"@type":"Question","name":"When should I use mean vs median?","acceptedAnswer":{"@type":"Answer","text":"Use mean when data is symmetrically distributed without outliers (like heights in a large population). Use median when data is skewed or has outliers (like income, house prices, or test scores with a few very high or low values). Median better represents the \'typical\' value in these cases."}},{"@type":"Question","name":"What do Q₁, Q₂, and Q₃ represent?","acceptedAnswer":{"@type":"Answer","text":"Q₁ (first quartile) is the 25th percentile, Q₂ (second quartile) is the median (50th percentile), and Q₃ (third quartile) is the 75th percentile. Together with minimum and maximum, they form the five-number summary used in box plots to visualize data distribution."}},{"@type":"Question","name":"Can the mean, median, and mode be the same value?","acceptedAnswer":{"@type":"Answer","text":"Yes, in a perfectly symmetric distribution (like a normal distribution), the mean, median, and mode will all be equal. However, in skewed distributions, these three measures will differ, with the degree of difference indicating the amount of skewness."}},{"@type":"Question","name":"How many data points do I need to calculate these statistics?","acceptedAnswer":{"@type":"Answer","text":"You need at least 2 data points for meaningful calculations. However, for more reliable statistical analysis, larger sample sizes are better. Generally, 30 or more data points provide more robust results, especially for understanding distribution patterns."}},{"@type":"Question","name":"What if my data set has no repeating values?","acceptedAnswer":{"@type":"Answer","text":"If no values repeat, there is no mode. This is common in continuous data or unique measurements. Our calculator will indicate \'No mode\' in such cases. You\'ll rely on mean and median to describe the central tendency of your data."}}]}' }}
      />
      <Navigation />
