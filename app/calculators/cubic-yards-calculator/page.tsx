  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-gray-100">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How many wheelbarrows are in a cubic yard?","acceptedAnswer":{"@type":"Answer","text":"A standard contractor\'s wheelbarrow holds about 6 cubic feet when level full. Since there are 27 cubic feet in a cubic yard, one cubic yard equals approximately 4.5 wheelbarrow loads. However, this can vary based on wheelbarrow size and how full you load it. Plan for 5-6 trips per cubic yard for easier handling."}},{"@type":"Question","name":"How do I convert square feet to cubic yards?","acceptedAnswer":{"@type":"Answer","text":"To convert square feet to cubic yards, you need to know the depth (thickness) of the material. First, convert depth to feet (e.g., 4 inches = 4/12 = 0.333 feet). Then multiply: square feet × depth in feet = cubic feet. Finally, divide cubic feet by 27 to get cubic yards. Example: 300 sq ft × 0.333 ft depth = 100 cu ft ÷ 27 = 3.7 cubic yards."}},{"@type":"Question","name":"How much does a cubic yard of concrete cost?","acceptedAnswer":{"@type":"Answer","text":"Concrete prices vary by location, type, and supplier but typically range from $120 to $150 per cubic yard for standard ready-mix concrete delivered. Specialty mixes (high-strength, fiber-reinforced, or colored concrete) can cost $150-$200+ per cubic yard. Always get quotes from multiple suppliers and factor in delivery fees, which usually apply to orders under a minimum quantity (often 10 yards)."}},{"@type":"Question","name":"What\'s the difference between a cubic yard and a square yard?","acceptedAnswer":{"@type":"Answer","text":"A square yard is a unit of area (length × width) measuring 9 square feet (3 ft × 3 ft), while a cubic yard is a unit of volume (length × width × depth) measuring 27 cubic feet (3 ft × 3 ft × 3 ft). Square yards measure flat surfaces like carpet or sod, while cubic yards measure three-dimensional quantities like concrete, mulch, or gravel."}},{"@type":"Question","name":"How deep should mulch be applied?","acceptedAnswer":{"@type":"Answer","text":"For garden beds and landscaping, mulch should be applied 2-4 inches deep. A 2-inch layer provides basic weed suppression and moisture retention, while 3-4 inches is ideal for better insulation and longer-lasting coverage. Avoid depths over 4 inches as this can suffocate plant roots and prevent water from reaching the soil. Refresh mulch annually as it decomposes."}},{"@type":"Question","name":"Can I pick up a cubic yard of material myself?","acceptedAnswer":{"@type":"Answer","text":"It depends on the material and your vehicle. A cubic yard of mulch (400-800 lbs) can usually fit in a pickup truck, but a cubic yard of gravel (2,700 lbs) or concrete (4,000 lbs) requires a heavy-duty truck or trailer and may exceed your vehicle\'s payload capacity. Most suppliers offer delivery, which is often more practical for heavy materials and ensures the proper amount is delivered."}},{"@type":"Question","name":"What is a \"ton\" of gravel in cubic yards?","acceptedAnswer":{"@type":"Answer","text":"One ton (2,000 lbs) of gravel is approximately 0.74 cubic yards, or about 20 cubic feet. However, this conversion depends on the type and density of the gravel. Crushed stone, pea gravel, and river rock have different weights per cubic yard. Most crushed stone weighs about 2,700 lbs per cubic yard, so 1 ton = about 0.74 yards, while 1 cubic yard = about 1.35 tons."}},{"@type":"Question","name":"How many cubic yards do I need for a driveway?","acceptedAnswer":{"@type":"Answer","text":"For a concrete driveway, use a minimum 4-inch depth. Calculate: measure length × width in feet, multiply by 0.333 (4 inches in feet), then divide by 27. For example, a 20 ft × 40 ft driveway: 20 × 40 × 0.333 = 266.4 cu ft ÷ 27 = 9.9 cubic yards. For a gravel driveway, use 4-6 inches depth for the base layer. Always order 10-15% extra."}}]}' }}
      />
      <Navigation />
