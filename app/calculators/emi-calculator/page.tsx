...
import { ArrowLeft, Calculator, TrendingUp, Home, Lightbulb, CheckCircle, HelpCircle, Target, BarChart3, PieChart, DollarSign, Percent, CreditCard, IndianRupee } from 'lucide-react';
          ...
          <section className="text-center py-12">
            <div className="bg-gradient-to-r from-[#1A3D7C] to-[#2BAE66] text-white p-8 rounded-2xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Need Help Understanding Loans & EMI?
              </h2>
              <p className="text-lg mb-6 opacity-90">
                Our expert mentors can guide you through loan planning, financial management, and smart borrowing strategies. Whether you're a student planning for education loans or a professional considering a home loan—we can help you make informed decisions.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/book-demo-class">
