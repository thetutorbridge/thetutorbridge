  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Q1: Which SGPA to percentage formula should I use?","acceptedAnswer":{"@type":"Answer","text":"Use the formula specified by your university. CBSE and most central universities use SGPA × 9.5. VTU uses (SGPA - 0.75) × 10. Anna University uses SGPA × 10 - 7.5. Mumbai University uses 7.1 × SGPA + 11. If unsure, check your university\'s academic regulations or ask your academic advisor. For general purposes or international applications, the generic formula (SGPA ÷ Scale) × 100 works universally."}},{"@type":"Question","name":"Q2: Is SGPA to percentage conversion accurate?","acceptedAnswer":{"@type":"Answer","text":"SGPA to percentage conversion is an approximation, not an exact conversion. Different universities use different formulas because SGPA and percentage are fundamentally different grading systems. The conversion is useful for applications and comparisons but may not match your actual marks percentage. For official documents, use your university\'s official conversion certificate if available."}},{"@type":"Question","name":"Q3: Can I use SGPA × 10 to get percentage?","acceptedAnswer":{"@type":"Answer","text":"No, SGPA × 10 is not the standard formula and will give inflated percentages. For 10-point scale, CBSE recommends SGPA × 9.5, not SGPA × 10. Using SGPA × 10 would mean an SGPA of 9.0 equals 90%, which is higher than the official 85.5%. Always use your university\'s approved formula. The multiplier of 9.5 was chosen by CBSE after studying the correlation between CGPA and percentage marks."}},{"@type":"Question","name":"Q4: How do I convert 4.0 scale GPA to percentage?","acceptedAnswer":{"@type":"Answer","text":"For 4.0 scale (common in US universities), use the formula: Percentage = (GPA ÷ 4.0) × 100. For example, GPA 3.5 = (3.5 ÷ 4.0) × 100 = 87.5%. This gives you the percentage equivalent. Note that some universities have specific conversion tables, so check if your institution provides one. Indian universities applying abroad often need this conversion for equivalency."}},{"@type":"Question","name":"Q5: What percentage is good for placements?","acceptedAnswer":{"@type":"Answer","text":"For campus placements in India: 75%+ (SGPA 7.9+) is excellent and qualifies for most top companies; 65-74% (SGPA 6.8-7.8) is good and meets most placement criteria; 60-64% (SGPA 6.3-6.7) is acceptable for many companies; 55-59% (SGPA 5.8-6.2) qualifies for several opportunities. Many top-tier companies have cutoffs around 70% (SGPA 7.4). However, cutoffs vary by company, sector, and economic conditions. Skills and projects are increasingly important alongside percentages."}},{"@type":"Question","name":"Q6: Should I convert SGPA or CGPA to percentage?","acceptedAnswer":{"@type":"Answer","text":"For most official purposes (job applications, higher education), convert CGPA (cumulative GPA), not individual semester SGPA. CGPA represents your overall performance across all semesters, which is what employers and universities want to see. Convert individual SGPA to percentage only if specifically asked for a particular semester\'s performance, such as \'Best semester percentage\' or for semester-wise transcripts."}},{"@type":"Question","name":"Q7: Do all universities follow the same SGPA scale?","acceptedAnswer":{"@type":"Answer","text":"No. While most Indian universities use a 10-point scale, some use 4-point (like US universities), 5-point, or even 7-point scales. International universities commonly use 4.0 scale (US), 5.0 scale (Germany), or percentage directly (UK). Always confirm your university\'s scale before conversion. The scale is usually mentioned on your grade card. Also, the same scale (like 10-point) can have different conversion formulas at different universities."}},{"@type":"Question","name":"Q8: Can percentage be higher than SGPA × 10?","acceptedAnswer":{"@type":"Answer","text":"No, percentage cannot legitimately exceed SGPA × 10 for a 10-point scale (which would mean more than 100% for SGPA 10). Standard formulas like CBSE (× 9.5) ensure percentage stays realistic. If any formula gives you >100%, cap it at 100%. Some students mistakenly use SGPA × 10 thinking it gives maximum percentage, but this is incorrect. The CBSE multiplier of 9.5 was specifically chosen to keep maximum percentage around 95% for perfect SGPA of 10."}}]}' }}
      />
      <Navigation />
