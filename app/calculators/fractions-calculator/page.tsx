  ...
  const renderFraction = (num: number, den: number, size: 'sm' | 'md' | 'lg' = 'md') => {
    ...
    return (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the difference between LCD and LCM?","acceptedAnswer":{"@type":"Answer","text":"LCD (Least Common Denominator) and LCM (Least Common Multiple) are the same concept applied to different contexts. LCD specifically refers to the LCM of the denominators when working with fractions. The calculation method is identical."}},{"@type":"Question","name":"How do I add fractions with different denominators?","acceptedAnswer":{"@type":"Answer","text":"Find the LCD of both denominators, convert each fraction to an equivalent fraction with the LCD as the denominator, then add the numerators while keeping the denominator the same. Finally, simplify the result if possible."}},{"@type":"Question","name":"Why do we flip the second fraction when dividing?","acceptedAnswer":{"@type":"Answer","text":"Dividing by a fraction is the same as multiplying by its reciprocal. This is because division is the inverse operation of multiplication. For example, dividing by 2/3 is the same as multiplying by 3/2 (the reciprocal)."}},{"@type":"Question","name":"When should I use improper fractions vs. mixed numbers?","acceptedAnswer":{"@type":"Answer","text":"Use improper fractions when performing calculations (they\'re easier to work with mathematically). Convert to mixed numbers for final answers or when the result needs to be more intuitive to understand. For example, 1 1/2 cups is clearer than 3/2 cups in a recipe."}},{"@type":"Question","name":"Can the denominator be zero?","acceptedAnswer":{"@type":"Answer","text":"No, a denominator cannot be zero. Division by zero is undefined in mathematics. A fraction with a zero denominator has no mathematical meaning. However, a numerator can be zero (e.g., 0/5 = 0)."}},{"@type":"Question","name":"How do I work with negative fractions?","acceptedAnswer":{"@type":"Answer","text":"The negative sign can be placed in the numerator, denominator, or in front of the entire fraction (they\'re all equivalent: -3/4 = 3/-4 = -(3/4)). By convention, we usually keep the denominator positive and place the negative sign in the numerator or in front. When adding or subtracting, treat the negative sign like you would with regular numbers."}},{"@type":"Question","name":"What\'s the fastest way to simplify a fraction?","acceptedAnswer":{"@type":"Answer","text":"Find the GCD (Greatest Common Divisor) of the numerator and denominator, then divide both by that number. The Euclidean algorithm is the fastest method for finding the GCD, especially with large numbers. Our calculator does this automatically for you."}},{"@type":"Question","name":"How do I convert a fraction to a decimal?","acceptedAnswer":{"@type":"Answer","text":"Divide the numerator by the denominator. For example, 3/4 = 3 ÷ 4 = 0.75. Some fractions result in repeating decimals (e.g., 1/3 = 0.333...), while others terminate (e.g., 1/2 = 0.5)."}}]}' }}
      />
