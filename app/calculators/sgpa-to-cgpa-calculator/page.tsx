  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Q1: What is the difference between SGPA and CGPA?","acceptedAnswer":{"@type":"Answer","text":"SGPA (Semester Grade Point Average) is the average grade point for a single semester, while CGPA (Cumulative Grade Point Average) is the overall average of all semesters combined. SGPA measures performance for one semester, whereas CGPA represents your entire academic performance from the start of your program."}},{"@type":"Question","name":"Q2: How is CGPA calculated from SGPA?","acceptedAnswer":{"@type":"Answer","text":"CGPA is calculated using a credit-weighted average. Multiply each semester\'s SGPA by its total credits, sum all these products, then divide by the total credits of all semesters. Formula: CGPA = Σ(SGPA × Credits) ÷ Σ(Credits). This ensures that semesters with more credits have proportionally more impact on your CGPA."}},{"@type":"Question","name":"Q3: Can I calculate CGPA by simply averaging all SGPAs?","acceptedAnswer":{"@type":"Answer","text":"Only if all semesters have the exact same number of credits. If credits vary between semesters (which is common), you must use the weighted formula. Simply averaging SGPAs will give an incorrect result when credit hours differ. Always use the credit-weighted calculation for accuracy."}},{"@type":"Question","name":"Q4: How do I convert CGPA to percentage?","acceptedAnswer":{"@type":"Answer","text":"For most Indian universities using a 10-point scale, use the formula: Percentage = CGPA × 9.5. For example, a CGPA of 8.0 equals 76%. However, conversion formulas can vary by university - CBSE uses ×9.5, some universities use (CGPA-0.5)×10, and international 4.0 scale uses (GPA÷4.0)×100. Always check your institution\'s official conversion method."}},{"@type":"Question","name":"Q5: What is a good CGPA for engineering students?","acceptedAnswer":{"@type":"Answer","text":"For engineering students in India: 9.0+ is outstanding and opens doors to top companies and higher education; 8.0-8.9 is excellent and highly competitive for good placements; 7.0-7.9 is very good and acceptable for most companies; 6.0-6.9 is good and meets most placement criteria; 5.0-5.9 is average. Most reputed companies have a cutoff around 6.5-7.0 CGPA."}},{"@type":"Question","name":"Q6: Does CGPA matter for higher studies and jobs?","acceptedAnswer":{"@type":"Answer","text":"Yes, significantly. For higher studies (MS, MBA, PhD), universities often have minimum CGPA requirements (typically 7.0-8.0 for good programs). For campus placements, many companies set CGPA cutoffs (usually 6.0-7.5). However, CGPA is just one factor - projects, internships, skills, and interviews are equally important. A lower CGPA can be compensated with strong practical experience and skills."}},{"@type":"Question","name":"Q7: How can I improve my CGPA in later semesters?","acceptedAnswer":{"@type":"Answer","text":"While it\'s harder to significantly improve CGPA in later semesters (since more credits are already counted), you can: 1) Score high in high-credit courses, 2) Maintain consistent 9.0+ SGPAs in remaining semesters, 3) Check if your university allows course retakes to replace poor grades, 4) Focus on core subjects with more credits, 5) Consider taking additional electives if it helps your average. Even small improvements compound over time."}},{"@type":"Question","name":"Q8: What happens to CGPA if I fail a subject?","acceptedAnswer":{"@type":"Answer","text":"If you fail a subject, it typically receives 0 grade points, which significantly impacts your SGPA for that semester and consequently your CGPA. When you retake and pass the course, universities usually either: 1) Replace the F grade with your new grade, or 2) Average both attempts. Check your university\'s policy. To minimize damage, retake failed courses as soon as possible and aim for the highest grade you can achieve."}}]}' }}
      />
      <Navigation />
