  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I measure the diameter of a round tank?","acceptedAnswer":{"@type":"Answer","text":"For accessible tanks, measure straight across the circular opening or end from one edge to the opposite edge, passing through the center point. For buried or inaccessible tanks, measure the circumference (distance around) and divide by π (3.14159) to get the diameter. Always measure the inside diameter for the most accurate volume calculation."}},{"@type":"Question","name":"What\'s the difference between tank capacity and volume?","acceptedAnswer":{"@type":"Answer","text":"Capacity is the maximum amount the tank can hold when completely full, while volume refers to the current amount of liquid in the tank based on the filled depth. Our calculator shows both: capacity when you enter just the tank dimensions, and actual volume when you also enter the filled depth."}},{"@type":"Question","name":"Can I use this calculator for underground tanks?","acceptedAnswer":{"@type":"Answer","text":"Yes, as long as you know the tank\'s dimensions and shape. For underground tanks, you\'ll typically need to consult the manufacturer\'s specifications or installation records for accurate measurements, as direct measurement is often not possible. The calculator works the same regardless of whether the tank is above ground, buried, or indoors."}},{"@type":"Question","name":"How accurate are the partial fill calculations?","acceptedAnswer":{"@type":"Answer","text":"Accuracy depends on tank shape. Vertical cylinders and rectangular tanks provide highly accurate partial fill calculations. Horizontal cylinders use exact geometric formulas for circular segments. More complex shapes like ovals and elliptical heads use approximation methods that are generally accurate within 2-5% for practical purposes. For critical applications, consider professional tank calibration."}},{"@type":"Question","name":"What if my tank has irregular dimensions or damage?","acceptedAnswer":{"@type":"Answer","text":"This calculator assumes ideal geometric shapes. For tanks with significant irregularities, dents, or deformation, the results may be less accurate. In such cases, consider: (1) measuring at multiple points and averaging, (2) professional tank strapping (calibration), or (3) using the manufacturer\'s capacity charts if available. Always err on the side of caution for safety-critical applications."}},{"@type":"Question","name":"Do I need to account for tank wall thickness?","acceptedAnswer":{"@type":"Answer","text":"For most practical applications, tank wall thickness has minimal impact on volume calculations (typically less than 1-2% difference). However, for the most accurate results, measure the inside dimensions of the tank rather than outside dimensions. This is especially important for small tanks or those with thick walls (like pressure vessels)."}},{"@type":"Question","name":"Can I calculate volume for tilted or slanted tanks?","acceptedAnswer":{"@type":"Answer","text":"This calculator assumes tanks are level (horizontal tanks) or perfectly vertical (vertical tanks). For tilted tanks, the calculations become significantly more complex and require advanced mathematics or engineering software. If your tank is not level, you should either level it or consult with a professional for accurate volume determination."}}]}' }}
      />
      <Navigation />
