...
import { ArrowLeft, Calculator, TrendingUp, Home, Lightbulb, CheckCircle, HelpCircle, Target, BarChart3, PieChart, DollarSign, Percent, Car, IndianRupee } from 'lucide-react';
          ...
          <section className="text-center py-12">
            <div className="bg-gradient-to-r from-[#1A3D7C] to-[#2BAE66] text-white p-8 rounded-2xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Need Help Planning Your Car Purchase?
              </h2>
              <p className="text-lg mb-6 opacity-90">
                Our expert mentors can guide you through car loan planning, budgeting, and making smart financial decisions for your vehicle purchase. Whether you're a student buying your first car or upgrading to a new vehicle—we're here to help!
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/book-demo-class">
