  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-gray-100">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I convert my percentage to CGPA?","acceptedAnswer":{"@type":"Answer","text":"The most common method in India is to divide your percentage by 9.5. For example, if your percentage is 85%, your CGPA would be 85 / 9.5 = 8.95 ≈ 8.9. However, different universities may use different formulas, so always check with your institution for the exact conversion method they use."}},{"@type":"Question","name":"What CGPA is 75 percentage?","acceptedAnswer":{"@type":"Answer","text":"Using the standard CBSE formula, 75% converts to a CGPA of 7.89 (75 / 9.5 = 7.89). This is typically rounded to 7.9 and falls in the &apos;A&apos; grade category with &apos;First Class with Distinction&apos; classification. This is considered a very good academic performance."}},{"@type":"Question","name":"What percentage is 9.5 CGPA?","acceptedAnswer":{"@type":"Answer","text":"A CGPA of 9.5 on a 10-point scale is equivalent to 90.25% (9.5 × 9.5 = 90.25%). This falls in the &apos;Outstanding&apos; or &apos;A+&apos; grade category and represents excellent academic achievement. Students with this CGPA are typically in the top percentile of their class."}},{"@type":"Question","name":"Is 8.5 CGPA good in engineering?","acceptedAnswer":{"@type":"Answer","text":"Yes, 8.5 CGPA is considered very good in engineering. It is equivalent to approximately 80.75% (8.5 × 9.5), which falls in the &apos;A+&apos; or &apos;Excellent&apos; grade category. This CGPA makes you eligible for most placements, higher studies, and scholarships. It demonstrates strong understanding and consistent performance in technical subjects."}},{"@type":"Question","name":"Can I get into IIT with 70 percentage?","acceptedAnswer":{"@type":"Answer","text":"70% converts to approximately 7.37 CGPA (70 / 9.5), which is a good score. For IIT admissions through JEE Advanced, your 12th board percentage/CGPA matters for eligibility. Most IITs require a minimum of 75% (65% for SC/ST/PwD) aggregate in 12th boards or be in the top 20 percentile of their board. So 70% might not meet the eligibility criteria for general category students, but check specific IIT requirements as rules can vary."}},{"@type":"Question","name":"What is the difference between GPA and CGPA?","acceptedAnswer":{"@type":"Answer","text":"GPA (Grade Point Average) typically refers to your grade point average for a single semester or term, while CGPA (Cumulative Grade Point Average) is the average of all your GPAs across all semesters. CGPA represents your overall academic performance throughout your course duration, whereas GPA shows performance in a specific period. Both use similar calculation methods but cover different time spans."}},{"@type":"Question","name":"Why do different universities have different conversion formulas?","acceptedAnswer":{"@type":"Answer","text":"Universities adopt different conversion formulas based on their grading philosophies, difficulty levels, and the percentage ranges their grade points represent. Some universities believe their grading system requires different weightage, leading to formulas like (% / 10) + 0.75 for Anna University or (% - 11) / 7.25 for Mumbai University. These variations account for institutional differences in assessment patterns and grading standards."}},{"@type":"Question","name":"How do employers view CGPA vs percentage?","acceptedAnswer":{"@type":"Answer","text":"Most employers accept both CGPA and percentage as valid measures of academic performance. However, many prefer percentage as it&apos;s more precise and easier to compare across institutions. When applying for jobs, you can mention both - for example, &quot;CGPA: 8.5/10 (80.75%)&quot;. Some companies have minimum cutoffs specified in percentage, so knowing how to convert your CGPA is important for job applications."}}]}' }}
      />
      <Navigation />
