  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-amber-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I calculate watts from volts and amps?","acceptedAnswer":{"@type":"Answer","text":"Multiply voltage by current: P = V × I . For example, a 120V device drawing 2 amps uses 120 × 2 = 240 watts."}},{"@type":"Question","name":"What is the difference between watts and volts?","acceptedAnswer":{"@type":"Answer","text":"Voltage (volts) is the electrical pressure or potential difference that pushes current through a circuit. Power (watts) is the rate at which energy is consumed or produced. Voltage is like water pressure; watts are like the flow rate."}},{"@type":"Question","name":"How many watts is 1 amp at 120 volts?","acceptedAnswer":{"@type":"Answer","text":"Using P = V × I: 120V × 1A = 120 watts . Similarly, at 240V, 1 amp equals 240 watts."}},{"@type":"Question","name":"How do I convert watts to amps?","acceptedAnswer":{"@type":"Answer","text":"Divide power by voltage: I = P ÷ V . A 1200W device at 120V draws 1200 ÷ 120 = 10 amps."}},{"@type":"Question","name":"What is 1 kilowatt equal to?","acceptedAnswer":{"@type":"Answer","text":"1 kilowatt (kW) = 1,000 watts . It\'s commonly used to measure larger power consumption like appliances and HVAC systems."}},{"@type":"Question","name":"How do I calculate power in a resistor?","acceptedAnswer":{"@type":"Answer","text":"Use any of these formulas: P = V × I , P = I² × R , or P = V² ÷ R . Choose based on which values you know."}},{"@type":"Question","name":"What is a gigawatt?","acceptedAnswer":{"@type":"Answer","text":"1 gigawatt (GW) = 1 billion watts (10⁹ W) . It\'s used to measure power plant output. For reference, the famous \'1.21 gigawatts\' from Back to the Future equals 1,210,000,000 watts."}},{"@type":"Question","name":"How does resistance affect power?","acceptedAnswer":{"@type":"Answer","text":"At constant voltage, lower resistance means higher power (P = V²/R). At constant current, higher resistance means higher power (P = I²R). This is why proper resistor sizing is critical in electronics."}}]}' }}
      />
      <Navigation />
