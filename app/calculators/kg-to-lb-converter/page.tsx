  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-50 via-teal-50 to-blue-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How many pounds are in a kilogram?","acceptedAnswer":{"@type":"Answer","text":"One kilogram equals approximately 2.20462 pounds. For most practical purposes, you can use 2.2 as the conversion factor. The exact value is 2.20462262185 pounds per kilogram."}},{"@type":"Question","name":"How many kilograms are in a pound?","acceptedAnswer":{"@type":"Answer","text":"One pound equals exactly 0.45359237 kilograms (by international definition). For everyday use, 0.45 or 0.454 provides sufficient accuracy."}},{"@type":"Question","name":"Why is it kg to lbs (plural) not kg to lb?","acceptedAnswer":{"@type":"Answer","text":"Both \'lb\' and \'lbs\' are correct abbreviations for pounds. \'Lb\' is technically correct as it comes from the Latin \'libra,\' but \'lbs\' is commonly used in informal writing to indicate plural. The official symbol is \'lb\' for both singular and plural."}},{"@type":"Question","name":"Is there a difference between weight and mass?","acceptedAnswer":{"@type":"Answer","text":"Technically, mass (measured in kilograms) is the amount of matter in an object, while weight is the force of gravity on that mass. However, on Earth\'s surface, the terms are often used interchangeably since the gravitational force is constant."}},{"@type":"Question","name":"How do I convert my body weight from kg to lbs?","acceptedAnswer":{"@type":"Answer","text":"Simply multiply your weight in kilograms by 2.205. For example, if you weigh 70 kg, your weight in pounds is 70 × 2.205 = 154.35 lbs. Use our calculator above for precise conversions."}},{"@type":"Question","name":"What is a stone and how does it relate to pounds?","acceptedAnswer":{"@type":"Answer","text":"A stone is a British unit of weight equal to 14 pounds (6.35 kg). It\'s commonly used in the UK and Ireland for measuring body weight. For example, a person weighing 150 pounds would be 10 stone 10 pounds."}},{"@type":"Question","name":"Which countries use pounds vs. kilograms?","acceptedAnswer":{"@type":"Answer","text":"The United States, Liberia, and Myanmar are the only countries that haven\'t officially adopted the metric system. The UK uses a mix, with most commerce in metric but personal weight often still expressed in stones and pounds."}},{"@type":"Question","name":"How accurate is this converter?","acceptedAnswer":{"@type":"Answer","text":"Our converter uses the internationally recognized exact conversion factor (1 lb = 0.45359237 kg). The results are accurate to many decimal places, far beyond what\'s needed for any practical application."}}]}' }}
      />
      <Navigation />
