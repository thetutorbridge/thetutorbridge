  ...
  return (
    <div className="flex flex-col min-h-screen">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the difference between percentage increase and percentage change?","acceptedAnswer":{"@type":"Answer","text":"Percentage increase specifically refers to growth (positive change), while percentage change can be either positive (increase) or negative (decrease). The formula is the same: [(New - Old) / Old] × 100 . If the result is positive, it\'s an increase; if negative, it\'s a decrease. Our calculator handles both automatically."}},{"@type":"Question","name":"Why do we divide by the original value?","acceptedAnswer":{"@type":"Answer","text":"Dividing by the original value provides context by showing how significant the change is relative to the starting point. A $10 increase represents 100% when starting from $10 but only 1% when starting from $1,000. The relative comparison is more meaningful than the absolute difference."}},{"@type":"Question","name":"Can I calculate percentage decrease with this calculator?","acceptedAnswer":{"@type":"Answer","text":"Yes! The calculator automatically detects both increases and decreases. Simply enter your starting and final values. If the final value is less than the starting value, the calculator will show a negative percentage and label it as a \'decrease\' rather than an \'increase.\'"}},{"@type":"Question","name":"What if the starting value is 0?","acceptedAnswer":{"@type":"Answer","text":"Percentage increase cannot be calculated when the starting value is 0 because you cannot divide by zero mathematically. If you\'re going from 0 to any positive number, that represents an infinite percentage increase. Instead, report the absolute change (e.g., \'increased by 50 units\' rather than a percentage)."}},{"@type":"Question","name":"How do I convert percentage increase to a multiplier?","acceptedAnswer":{"@type":"Answer","text":"To convert a percentage increase to a multiplier, divide the percentage by 100 and add 1. For example, a 25% increase = 1.25x multiplier (25/100 + 1 = 1.25). To find the new value, multiply the original by this multiplier: $100 × 1.25 = $125."}},{"@type":"Question","name":"Can percentage increases exceed 100%?","acceptedAnswer":{"@type":"Answer","text":"Yes! A percentage increase can be any positive number. If a value doubles, that\'s a 100% increase. If it triples, that\'s a 200% increase. If a stock goes from $10 to $50, that\'s a 400% increase. There\'s no upper limit to percentage increases."}},{"@type":"Question","name":"Is percentage increase the same as compound interest?","acceptedAnswer":{"@type":"Answer","text":"No, they\'re different concepts. Percentage increase measures a single change from one value to another. Compound interest involves repeated percentage increases over multiple time periods, where each period\'s interest is calculated on the new total including previous interest. Compound interest uses the formula: A = P(1 + r)ⁿ ."}},{"@type":"Question","name":"How accurate is this calculator?","acceptedAnswer":{"@type":"Answer","text":"Our calculator provides results accurate to 4 decimal places (e.g., 25.1765%), which is more than sufficient for virtually all practical applications. The underlying JavaScript calculations use double-precision floating-point arithmetic, ensuring mathematical accuracy for financial, business, and educational purposes."}}]}' }}
      />
      <Navigation />
