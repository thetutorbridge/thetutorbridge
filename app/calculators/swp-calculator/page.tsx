...
import { Wallet, Home, ArrowRight, TrendingDown, Shield, Clock, Calculator, DollarSign, BookOpen } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <h2 className="text-2xl md:text-4xl font-bold mb-4">
              Need Help with Withdrawal & Investment Mathematics?
            </h2>
