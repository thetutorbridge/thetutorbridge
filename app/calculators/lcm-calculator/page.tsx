  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the LCM of 0 and any number?","acceptedAnswer":{"@type":"Answer","text":"Technically, LCM is undefined for 0 because every number is a divisor of 0, so there\'s no \'least\' common multiple. In practice, we only find LCM of positive integers. Our calculator requires positive integers only."}},{"@type":"Question","name":"Can LCM be smaller than one of the numbers?","acceptedAnswer":{"@type":"Answer","text":"No, the LCM is always greater than or equal to the largest number in the set. It must be a multiple of each number, so it can\'t be smaller than any of them. The only time LCM equals the largest number is when that number is already a multiple of all the others."}},{"@type":"Question","name":"How is LCM different from LCD?","acceptedAnswer":{"@type":"Answer","text":"LCD (Least Common Denominator) is the LCM of the denominators of two or more fractions. They\'re the same mathematical concept - LCD is just LCM applied specifically to fraction denominators. When adding fractions, you find the LCD to get a common denominator."}},{"@type":"Question","name":"What\'s the LCM of two prime numbers?","acceptedAnswer":{"@type":"Answer","text":"The LCM of two prime numbers is always their product. Since prime numbers share no common factors (their GCF is 1), you multiply them together. For example, LCM(7, 11) = 77, and LCM(3, 5) = 15."}},{"@type":"Question","name":"Why do we need LCM for adding fractions?","acceptedAnswer":{"@type":"Answer","text":"To add fractions, they must have the same denominator. The LCM of the denominators gives us the smallest common denominator, making the calculation easier and resulting in a simpler answer. For example, to add 1/4 + 1/6, we use LCM(4,6) = 12 as the common denominator."}},{"@type":"Question","name":"What if all numbers are the same?","acceptedAnswer":{"@type":"Answer","text":"If all numbers are identical, the LCM is that number itself. For example, LCM(5, 5, 5) = 5. This makes sense because the number is already a multiple of itself and is the smallest such multiple."}},{"@type":"Question","name":"Can I find LCM of negative numbers?","acceptedAnswer":{"@type":"Answer","text":"LCM is typically defined only for positive integers. While you could extend the concept to negative numbers, the standard mathematical definition and most practical applications use only positive integers. Our calculator works with positive integers only."}},{"@type":"Question","name":"How many numbers can I find the LCM of at once?","acceptedAnswer":{"@type":"Answer","text":"Mathematically, you can find the LCM of any quantity of numbers. Our calculator supports 2-10 numbers at once, which covers the vast majority of practical applications. To find LCM of more numbers, you can find it in groups, then find the LCM of those results."}}]}' }}
      />
      <Navigation />
