  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I calculate hours between two times?","acceptedAnswer":{"@type":"Answer","text":"Enter the start time and end time in hhmm format (without colons). For example, 9:15 AM = 915, 2:30 PM = 230. Select AM/PM for 12-hour format or use 24-hour format (14:30 = 1430). The calculator instantly shows the time difference in hours:minutes, decimal hours, and total minutes."}},{"@type":"Question","name":"Can this calculator handle overnight shifts?","acceptedAnswer":{"@type":"Answer","text":"Yes! The calculator automatically handles shifts that cross midnight. For example, if you work from 11:00 PM to 7:00 AM, enter 2300 and 700 (24-hour format) or 11:00 PM and 7:00 AM (12-hour format). It will correctly calculate 8 hours of work time."}},{"@type":"Question","name":"What is decimal hours and why is it useful?","acceptedAnswer":{"@type":"Answer","text":"Decimal hours represent time as a decimal number (e.g., 7.5 hours instead of 7:30). This format is essential for payroll calculations — you can directly multiply decimal hours by hourly wage rate. For example: 7.5 hours × $20/hour = $150 (easier than calculating 7:30 × $20)."}},{"@type":"Question","name":"How do I deduct break time?","acceptedAnswer":{"@type":"Answer","text":"Enter your total break time in minutes in the \"Deduct breaks\" field. For example, if you had a 30-minute lunch and two 15-minute coffee breaks, enter 60 minutes (30+15+15). The calculator automatically subtracts this from your total hours to show net working time."}},{"@type":"Question","name":"What\'s the difference between 12-hour and 24-hour format?","acceptedAnswer":{"@type":"Answer","text":"12-hour format uses AM/PM (9:00 AM, 5:00 PM) — common in USA, Canada, India. 24-hour format runs 00:00 to 23:59 (09:00, 17:00) — used in military, healthcare, and most of Europe. Choose whichever you\'re comfortable with; both give identical results."}},{"@type":"Question","name":"Can I calculate time for multiple days?","acceptedAnswer":{"@type":"Answer","text":"This calculator works for single-day calculations (up to 24 hours). For multi-day periods, calculate each day separately and add the results. For example, if you worked 8 hours Monday, 7.5 hours Tuesday, and 9 hours Wednesday, calculate each day and sum: 8 + 7.5 + 9 = 24.5 hours total."}},{"@type":"Question","name":"How accurate is this calculator for payroll?","acceptedAnswer":{"@type":"Answer","text":"The calculator provides precise time calculations suitable for payroll processing. However, always verify against your company\'s official timekeeping system. Different organizations may have specific rounding rules (e.g., round to nearest 15 minutes) or overtime calculation policies."}},{"@type":"Question","name":"What if I enter times in the wrong format?","acceptedAnswer":{"@type":"Answer","text":"The calculator expects hhmm format without colons (e.g., 915 not 9:15). If you enter invalid times like 2561 (25 hours, 61 minutes), results may be inaccurate. Always enter: hours (00-23 or 01-12) followed immediately by minutes (00-59). Examples: 900, 1430, 2359."}}]}' }}
      />
      <Navigation />
