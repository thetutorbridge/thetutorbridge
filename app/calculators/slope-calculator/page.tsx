  ...
  const CustomDot = (props: any) => {
    ...
    if (isPoint1 || isPoint2) {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the difference between slope and gradient?","acceptedAnswer":{"@type":"Answer","text":"In mathematics, \"slope\" and \"gradient\" are often used interchangeably to describe the steepness of a line. However, in some contexts, gradient can refer to a vector field or the rate of change in multiple dimensions. For lines in two-dimensional space, they mean the same thing."}},{"@type":"Question","name":"Can slope be greater than 1?","acceptedAnswer":{"@type":"Answer","text":"Yes! Slope can be any real number. A slope greater than 1 or less than −1 indicates a steep line. For example, a slope of 5 means the line rises 5 units vertically for every 1 unit horizontally, making it quite steep."}},{"@type":"Question","name":"How do I find slope from an equation?","acceptedAnswer":{"@type":"Answer","text":"If the equation is in slope-intercept form (y = mx + b), the slope is the coefficient m. If it\'s in standard form (Ax + By = C), solve for y to get slope-intercept form, or use m = −A/B. For other forms, identify two points on the line and use the slope formula."}},{"@type":"Question","name":"What does a slope of 1 mean?","acceptedAnswer":{"@type":"Answer","text":"A slope of 1 means the line rises 1 unit vertically for every 1 unit it moves horizontally. This creates a 45-degree angle with the x-axis. The line rises at a consistent, moderate rate."}},{"@type":"Question","name":"Why is vertical line slope undefined?","acceptedAnswer":{"@type":"Answer","text":"A vertical line has the same x-coordinate for all points, making the denominator (x₂ − x₁) equal to zero. Since division by zero is undefined in mathematics, we say the slope is undefined. You can think of it as \"infinitely steep.\""}},{"@type":"Question","name":"How is slope used in real life?","acceptedAnswer":{"@type":"Answer","text":"Slope appears in countless real-world applications: road grades (for example, a 6% grade means a slope of 0.06), roof pitch in construction, ski slope difficulty ratings, wheelchair ramp specifications, economic graphs showing rates of change, velocity on distance-time graphs, and drainage systems in civil engineering."}},{"@type":"Question","name":"What is the slope of the x-axis?","acceptedAnswer":{"@type":"Answer","text":"The x-axis is a horizontal line where y = 0 for all values of x. Since there\'s no vertical change regardless of horizontal movement, the slope is 0. Similarly, any horizontal line (y = c) has a slope of 0."}},{"@type":"Question","name":"Can I use this calculator for finding slope from a graph?","acceptedAnswer":{"@type":"Answer","text":"Yes! If you have a graph, identify two clear points on the line, read their coordinates, and enter them into the calculator. The calculator will find the slope and show you the step-by-step solution. Our graph visualization will also help you verify your points are correct."}}]}' }}
      />
