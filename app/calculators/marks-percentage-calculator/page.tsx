  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Q1: How do I calculate percentage if I have marks in different subjects with different maximum marks?","acceptedAnswer":{"@type":"Answer","text":"Add up all the marks you obtained across all subjects to get total marks obtained. Then add up all the maximum marks of all subjects to get total marks. Use the formula: Percentage = (Total Marks Obtained / Total Maximum Marks) × 100. For example, if you scored 85/100 in English, 120/150 in Math, and 40/50 in Science, then Total Obtained = 85+120+40 = 245, Total Maximum = 100+150+50 = 300, Percentage = (245/300) × 100 = 81.67%."}},{"@type":"Question","name":"Q2: What is the passing percentage in most Indian boards?","acceptedAnswer":{"@type":"Answer","text":"In most Indian education boards (CBSE, ICSE, and state boards), the minimum passing percentage is 33%. However, some boards and universities have a higher passing threshold of 35% or 40%. Additionally, students often need to score a minimum percentage in each subject individually (usually 33%) to pass overall. Always check your specific board\'s requirements."}},{"@type":"Question","name":"Q3: How is percentage different from CGPA or GPA?","acceptedAnswer":{"@type":"Answer","text":"Percentage is calculated as (Marks Obtained / Total Marks) × 100 and ranges from 0 to 100. CGPA (Cumulative Grade Point Average) is calculated on a scale (usually 10 or 4 points) based on grade points assigned to percentage ranges. To convert CBSE percentage to CGPA (10-point scale), divide by 9.5. To convert CGPA to percentage, multiply by 9.5. For example, 85% = 85/9.5 ≈ 8.95 CGPA, and 9.0 CGPA = 9.0 × 9.5 = 85.5%."}},{"@type":"Question","name":"Q4: Can I calculate percentage by averaging individual subject percentages?","acceptedAnswer":{"@type":"Answer","text":"No, this is a common mistake! You should NOT calculate each subject\'s percentage and then average them. Instead, add all marks obtained and all total marks, then calculate percentage once. For example, if you scored 80/100 in Subject A and 60/100 in Subject B: WRONG method = (80% + 60%)/2 = 70%. CORRECT method = (80+60)/(100+100) × 100 = 70%. While both give the same answer here, they will differ when subjects have different maximum marks."}},{"@type":"Question","name":"Q5: What percentage is considered good for college admissions?","acceptedAnswer":{"@type":"Answer","text":"For top Indian universities and colleges, 90% and above is considered excellent and highly competitive. 80-89% is very good and qualifies you for most good colleges. 75-79% is above average and acceptable for many colleges. 60-74% is considered average. However, cutoffs vary significantly by course, college, and category (General/OBC/SC/ST). Engineering colleges typically require 75-90%+, medical colleges require 90-95%+, and top commerce/arts colleges require 85-95%+ for admission."}},{"@type":"Question","name":"Q6: How do I calculate semester percentage or annual percentage?","acceptedAnswer":{"@type":"Answer","text":"For semester percentage, add all marks obtained in that semester across all subjects, divide by total maximum marks for that semester, and multiply by 100. For annual percentage combining multiple semesters, add marks obtained in ALL semesters, divide by total maximum marks of ALL semesters combined, and multiply by 100. For example, Semester 1: 400/500, Semester 2: 450/500. Annual = (400+450)/(500+500) × 100 = 850/1000 × 100 = 85%."}},{"@type":"Question","name":"Q7: What if my marks include decimal points or grace marks?","acceptedAnswer":{"@type":"Answer","text":"The calculation remains exactly the same! Many boards now award decimal marks (like 87.5 or 92.25) especially after re-evaluation or when grace marks are added. Simply use these decimal values in your calculation. For example, if you scored 432.5 out of 500, your percentage = (432.5/500) × 100 = 86.5%. Always include grace marks in your total marks obtained if they\'ve been officially added to your marksheet."}},{"@type":"Question","name":"Q8: How do I calculate aggregate percentage for subjects with practical exams?","acceptedAnswer":{"@type":"Answer","text":"For subjects with both theory and practical components (like Science subjects), add the theory marks and practical marks together for that subject. For example, if Chemistry has Theory (70 marks) and Practical (30 marks), and you scored 58 in theory and 27 in practical, your total Chemistry marks = 58+27 = 85 out of 100. Then combine this with other subjects to calculate overall percentage. Theory and practical are treated as one combined subject total."}}]}' }}
      />
      <Navigation />
