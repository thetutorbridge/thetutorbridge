  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the GCF of 0 and any number?","acceptedAnswer":{"@type":"Answer","text":"The GCF involving 0 is mathematically defined as the absolute value of the non-zero number, since every integer divides 0. However, for practical purposes, most calculators (including ours) don\'t accept 0 as an input. In standard elementary mathematics, we work only with positive integers for GCF."}},{"@type":"Question","name":"Can GCF be larger than the smallest number?","acceptedAnswer":{"@type":"Answer","text":"No, the GCF can never be larger than the smallest number in the set. The GCF must divide evenly into all numbers, so it cannot exceed the smallest one. In fact, the GCF is at most equal to the smallest number (when that number divides all others)."}},{"@type":"Question","name":"What does it mean if GCF = 1?","acceptedAnswer":{"@type":"Answer","text":"When GCF = 1, the numbers are called \'relatively prime\' or \'coprime.\' This means they share no common factors except 1. For example, GCF(8, 15) = 1. This is common with prime numbers or consecutive integers. It doesn\'t mean the numbers themselves are prime—just that they don\'t share prime factors."}},{"@type":"Question","name":"What\'s the GCF of two prime numbers?","acceptedAnswer":{"@type":"Answer","text":"The GCF of two different prime numbers is always 1. Prime numbers have no factors other than 1 and themselves, so they can\'t share any common factors except 1. For example, GCF(7, 11) = 1, GCF(3, 5) = 1. However, GCF(7, 7) = 7 since a number and itself have that number as their GCF."}},{"@type":"Question","name":"How is GCF used to simplify fractions?","acceptedAnswer":{"@type":"Answer","text":"To simplify a fraction, divide both the numerator and denominator by their GCF. For example, to simplify 18/24: find GCF(18, 24) = 6, then divide: 18÷6 = 3 and 24÷6 = 4, giving 3/4 in lowest terms. This ensures the fraction is reduced as much as possible."}},{"@type":"Question","name":"Can you find GCF of negative numbers?","acceptedAnswer":{"@type":"Answer","text":"Yes, but GCF is defined as a positive integer. When calculating GCF of negative numbers, use their absolute values. For example, GCF(-12, -18) = GCF(12, 18) = 6. The GCF itself is always positive, even when the original numbers are negative."}},{"@type":"Question","name":"What if all numbers are the same?","acceptedAnswer":{"@type":"Answer","text":"If all numbers are identical, the GCF is that number itself. For example, GCF(5, 5, 5) = 5. This makes sense because the number divides itself and is the largest number that does so. Similarly, GCF(n, n) = n for any number n."}},{"@type":"Question","name":"How do I find GCF of fractions or decimals?","acceptedAnswer":{"@type":"Answer","text":"GCF is defined only for integers, not fractions or decimals. If you have fractions, you can find the GCF of the numerators and denominators separately. For decimals, convert them to fractions first, or multiply by a power of 10 to make them whole numbers, find the GCF, then adjust accordingly."}}]}' }}
      />
      <Navigation />
