  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What does a standard deviation of 0 mean?","acceptedAnswer":{"@type":"Answer","text":"A standard deviation of 0 means there is no variability in the data—all values are identical. This would occur if you measured the same exact value multiple times, such as recording \'5, 5, 5, 5\' as your dataset. In this case, every value equals the mean, so all deviations are zero."}},{"@type":"Question","name":"Can standard deviation be negative?","acceptedAnswer":{"@type":"Answer","text":"No, standard deviation can never be negative. Since it\'s calculated as the square root of variance (which is the sum of squared values), the result must always be zero or positive. If you get a negative standard deviation, you\'ve made a calculation error."}},{"@type":"Question","name":"What\'s the difference between standard deviation and standard error?","acceptedAnswer":{"@type":"Answer","text":"Standard deviation measures the variability of individual data points in a dataset, while standard error measures the precision of the sample mean as an estimate of the population mean. Standard error is calculated as SE = s / √n, where s is the standard deviation and n is the sample size. As sample size increases, standard error decreases, but standard deviation remains roughly constant."}},{"@type":"Question","name":"How many data points do I need to calculate standard deviation?","acceptedAnswer":{"@type":"Answer","text":"For population standard deviation, you can calculate it with any number of data points (even one, though it would be zero). For sample standard deviation, you need at least two data points because the formula uses (n − 1) in the denominator. With only one point, you\'d divide by zero, which is undefined. However, for meaningful statistical analysis, you generally want much larger sample sizes—typically at least 30 for the central limit theorem to apply."}},{"@type":"Question","name":"What does it mean when standard deviation is higher than the mean?","acceptedAnswer":{"@type":"Answer","text":"When standard deviation exceeds the mean, it indicates very high relative variability in the data. This often occurs with right-skewed distributions or data that includes some very large outliers. For example, in income data, the standard deviation might exceed the mean because a small number of very high earners pull the standard deviation up while the mean remains relatively modest. This situation suggests you should examine your data carefully for outliers or consider whether the data follows"}},{"@type":"Question","name":"How is standard deviation used in the 68-95-99.7 rule?","acceptedAnswer":{"@type":"Answer","text":"The 68-95-99.7 rule (also called the empirical rule) applies to normal distributions and states that approximately 68% of data falls within 1 standard deviation of the mean, 95% within 2 standard deviations, and 99.7% within 3 standard deviations. This rule helps you understand what constitutes a \'normal\' value versus an outlier. For example, if test scores have a mean of 75 and standard deviation of 10, about 68% of students scored between 65 and 85."}},{"@type":"Question","name":"Should I remove outliers before calculating standard deviation?","acceptedAnswer":{"@type":"Answer","text":"This depends on your analysis goals. Outliers can significantly affect standard deviation, so if they represent data errors or aren\'t relevant to your analysis, removing them might be appropriate. However, if outliers represent genuine variability in your data, removing them would give a misleadingly low standard deviation that doesn\'t accurately represent your data\'s true spread. Always investigate outliers to understand their cause before deciding whether to include or exclude them, and docume"}}]}' }}
      />
      <Navigation />
