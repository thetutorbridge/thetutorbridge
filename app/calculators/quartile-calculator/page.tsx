  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-gray-100">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the difference between quartiles and percentiles?","acceptedAnswer":{"@type":"Answer","text":"Quartiles are special cases of percentiles that divide data into four equal parts. Q₁ is the 25th percentile, Q₂ is the 50th percentile (median), and Q₃ is the 75th percentile. While percentiles can be any value from 1 to 99, quartiles specifically refer to the 25%, 50%, and 75% marks."}},{"@type":"Question","name":"Why is the IQR useful?","acceptedAnswer":{"@type":"Answer","text":"The IQR is useful because it measures the spread of the middle 50% of your data and is not affected by extreme outliers. Unlike the range (which uses the minimum and maximum), the IQR provides a more stable measure of variability, making it ideal for comparing datasets and identifying unusual observations."}},{"@type":"Question","name":"How do you handle even vs. odd number of data points?","acceptedAnswer":{"@type":"Answer","text":"For odd-numbered datasets, the median (Q₂) is the middle value. For even-numbered datasets, the median is the average of the two middle values. When finding Q₁ and Q₃, different methods exist: some exclude Q₂ from both halves, others include it in both. Our calculator uses the exclusive method, which is commonly taught in statistics courses."}},{"@type":"Question","name":"Can quartiles be used with small datasets?","acceptedAnswer":{"@type":"Answer","text":"While quartiles can technically be calculated for any dataset with at least 4 values, they are most meaningful with larger datasets (n ≥ 20). With very small datasets, quartiles may not provide as much insight into data distribution, and other statistical measures might be more appropriate."}},{"@type":"Question","name":"What does it mean if Q₁ = Q₂ or Q₂ = Q₃?","acceptedAnswer":{"@type":"Answer","text":"If Q₁ = Q₂, it means that at least 50% of your data values are the same (at or above Q₁). Similarly, if Q₂ = Q₃, at least 50% of values are at or below Q₃. This often indicates a skewed distribution or many repeated values in your dataset."}}]}' }}
      />
      <Navigation />
