  ...
  const ButtonCalc = ({ children, onClick, className = '', variant = 'default' }: any) => {
    ...
    return (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Is this calculator completely free to use?","acceptedAnswer":{"@type":"Answer","text":"Yes, this online calculator is 100% free with no hidden costs, registration requirements, or trial periods. You can use it unlimited times from any device. No downloads or installations needed - it works directly in your web browser on desktop, mobile, or tablet."}},{"@type":"Question","name":"Does this work on mobile phones and tablets?","acceptedAnswer":{"@type":"Answer","text":"Absolutely! The calculator is fully responsive and optimized for all screen sizes. The buttons are large and touch-friendly for easy use on smartphones and tablets. It works on iOS (iPhone/iPad), Android devices, and all modern mobile browsers without any issues."}},{"@type":"Question","name":"How do I use the memory functions (MC, MR, M+, M-)?","acceptedAnswer":{"@type":"Answer","text":"M+ adds the current display to memory. M- subtracts it from memory. MR recalls (shows) the stored memory value. MC clears memory. Example: Calculate 15 + 8 = 23, press M+. Calculate 10 × 2 = 20, press M+. Now press MR to see total: 43 (23+20)."}},{"@type":"Question","name":"What is the difference between AC and DEL?","acceptedAnswer":{"@type":"Answer","text":"AC (All Clear) resets the entire calculator - clearing the display, operations, and previous values. It\'s like starting completely fresh. DEL (Delete) removes only the last digit you entered, perfect for fixing typos without clearing everything. Example: If you entered 1234 by mistake instead of 123, press DEL once to remove the 4."}},{"@type":"Question","name":"How do I calculate percentages?","acceptedAnswer":{"@type":"Answer","text":"The % button converts the displayed number to decimal by dividing by 100. For discounts: Calculate 200 × 20 = 4000, press % to get 40 (20% of 200). For percentage of a number: Enter the number, press ×, enter percentage, press =, then %. Example: What is 15% of 80? → 80 × 15 = 1200, press % → 12."}},{"@type":"Question","name":"Can I use keyboard shortcuts?","acceptedAnswer":{"@type":"Answer","text":"Currently, this calculator is designed for mouse/touch input. You can click the on-screen buttons with your mouse or tap them on touch devices. Keyboard support may be added in future updates. For now, the large clickable buttons provide easy, accurate input."}},{"@type":"Question","name":"What does the x^y button do?","acceptedAnswer":{"@type":"Answer","text":"x^y calculates \'x to the power of y\' or exponentiation. Enter the base number (x), press x^y, enter the exponent (y), then press =. Example: To calculate 2³ (2 cubed): Press 2 → x^y → 3 → = → Result: 8. For 5² (5 squared), you can also use the x² button directly."}},{"@type":"Question","name":"Why does division by zero show \"Error\"?","acceptedAnswer":{"@type":"Answer","text":"Division by zero is mathematically undefined and would result in infinity or error. When you try to divide any number by 0, the calculator displays \'Error\' to prevent incorrect results. Press AC to clear the error and start a new calculation. This is standard behavior for all calculators."}}]}' }}
      />
        {children}
      </button>
    );
