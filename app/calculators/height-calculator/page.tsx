  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How accurate is this height calculator?","acceptedAnswer":{"@type":"Answer","text":"The Khamis-Roche method has a 90% accuracy rate with a margin of error of ±2.1 inches for boys and ±1.7 inches for girls. The mid-parental method has a larger margin of ±4 inches but is useful for quick estimates."}},{"@type":"Question","name":"At what age can I predict my child&apos;s height?","acceptedAnswer":{"@type":"Answer","text":"The Khamis-Roche method works for children aged 4 to 17.5 years. For younger children, height predictions are less reliable due to high variability in early growth patterns."}},{"@type":"Question","name":"Why is my child&apos;s weight needed for the prediction?","acceptedAnswer":{"@type":"Answer","text":"Weight provides important information about a child&apos;s nutritional status and growth trajectory. Children who are heavier for their age may be further along in their growth, affecting the prediction."}},{"@type":"Question","name":"Can medical conditions affect my child&apos;s predicted height?","acceptedAnswer":{"@type":"Answer","text":"Yes. Growth hormone deficiencies, thyroid disorders, chronic illnesses, and other medical conditions can significantly affect height. These predictions assume normal, healthy growth. Consult a pediatrician if you have concerns about your child&apos;s growth."}},{"@type":"Question","name":"Why are there different predictions for different ethnicities?","acceptedAnswer":{"@type":"Answer","text":"The Khamis-Roche method was developed using data from Caucasian American children. Different ethnic populations may have different growth patterns, so the predictions may be less accurate for children of other backgrounds."}},{"@type":"Question","name":"When do children stop growing?","acceptedAnswer":{"@type":"Answer","text":"Girls typically stop growing around age 14-16, while boys continue growing until about 16-18 years old. However, some individuals may continue growing slightly into their early 20s."}}]}' }}
      />
      <Navigation />
