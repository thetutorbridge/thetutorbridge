  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is a good net profit margin?","acceptedAnswer":{"@type":"Answer","text":"A \'good\' net profit margin varies by industry. Software companies might target 20-30%, while grocery stores operate successfully on 1-3%. Generally, higher margins are better, but compare your margin to industry averages and your own historical performance to assess whether your margin is good for your specific business."}},{"@type":"Question","name":"What\'s the difference between gross profit margin and net profit margin?","acceptedAnswer":{"@type":"Answer","text":"Gross profit margin only considers direct costs (cost of goods sold), while net profit margin includes all expenses (operating costs, taxes, interest, etc.). Net profit margin provides a more complete picture of overall profitability, while gross margin focuses on production efficiency."}},{"@type":"Question","name":"Can profit margin be negative?","acceptedAnswer":{"@type":"Answer","text":"Yes, profit margin can be negative when costs exceed revenue, resulting in a net loss. A negative profit margin means the business is losing money on each sale and is not sustainable long-term without corrective action or additional funding."}},{"@type":"Question","name":"How often should I calculate profit margin?","acceptedAnswer":{"@type":"Answer","text":"Calculate profit margin monthly or quarterly to track trends and identify issues early. Many businesses also calculate margins by product line, customer segment, or sales channel to understand which areas are most profitable and where improvements are needed."}},{"@type":"Question","name":"What costs should be included in the calculation?","acceptedAnswer":{"@type":"Answer","text":"For net profit margin, include all costs: cost of goods sold, operating expenses, salaries, rent, utilities, marketing, depreciation, interest, and taxes. The more comprehensive your cost accounting, the more accurate your profit margin calculation will be."}}]}' }}
      />
      <Navigation />
