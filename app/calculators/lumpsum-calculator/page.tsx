  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is a lumpsum investment?","acceptedAnswer":{"@type":"Answer","text":"A lumpsum investment is a one-time investment where you invest a large amount of money at once, rather than investing smaller amounts regularly. Examples include investing bonus money, inheritance, maturity proceeds from FD/insurance, or sale proceeds from property/assets."}},{"@type":"Question","name":"How does the lumpsum calculator work?","acceptedAnswer":{"@type":"Answer","text":"The calculator uses the compound interest formula: A = P(1 + r)^t, where A is final amount, P is principal (your investment), r is annual return rate, and t is time period in years. For example, ₹1 lakh at 12% for 10 years grows to ₹3,10,585."}},{"@type":"Question","name":"Lumpsum vs SIP - which is better?","acceptedAnswer":{"@type":"Answer","text":"Both have advantages. Lumpsum works best when markets are at lower levels or during corrections, potentially giving higher returns. SIP works best for regular salaried investors and provides rupee cost averaging, reducing timing risk. Choose based on your available capital and market conditions."}},{"@type":"Question","name":"What is a good return rate for lumpsum investments?","acceptedAnswer":{"@type":"Answer","text":"Expected returns vary by asset class: Equity mutual funds: 10-15%, Debt funds: 6-8%, Hybrid funds: 8-12%, Fixed deposits: 5-7%. Equity investments carry higher risk but potentially higher returns over long term (10+ years). Always diversify your portfolio."}},{"@type":"Question","name":"What is the minimum lumpsum investment amount?","acceptedAnswer":{"@type":"Answer","text":"Minimum amounts vary by instrument. Mutual funds: ₹500-₹5,000, Stocks: No minimum (one share), PPF: ₹500, NSC/KVP: ₹1,000, Fixed Deposits: ₹1,000-₹10,000. Our calculator works for any amount from ₹1,000 to ₹10 crore."}},{"@type":"Question","name":"Can I withdraw my lumpsum investment anytime?","acceptedAnswer":{"@type":"Answer","text":"It depends on the investment type. Mutual funds (open-ended): Usually yes, with possible exit load if redeemed before 1 year. Fixed deposits: Yes, with penalty. PPF: Partial withdrawals after 7 years. ELSS: 3-year lock-in. Stocks: Anytime during market hours. Always check lock-in periods before investing."}},{"@type":"Question","name":"Are lumpsum returns guaranteed?","acceptedAnswer":{"@type":"Answer","text":"Only for certain instruments. Guaranteed returns: Fixed deposits, PPF, NSC, government bonds. Market-linked returns: Mutual funds, stocks, ETFs - these can fluctuate. The calculator shows estimated returns based on assumed rate; actual returns may vary based on market performance."}},{"@type":"Question","name":"What is the ideal time period for lumpsum investment?","acceptedAnswer":{"@type":"Answer","text":"For equity investments, minimum 5-7 years recommended to ride out market volatility and benefit from compounding. For debt/fixed income, 1-3 years works well. Longer time periods significantly amplify returns - ₹1L at 12% grows to ₹3.1L in 10 years but ₹9.6L in 20 years!"}}]}' }}
      />
      <Navigation />
