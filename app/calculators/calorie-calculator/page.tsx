  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How accurate are calorie calculators?","acceptedAnswer":{"@type":"Answer","text":"Calorie calculators provide estimates based on population averages. Individual variation in metabolism can cause actual needs to differ by ±10-20%. Use the calculator as a starting point, then adjust based on your real-world results over 2-4 weeks."}},{"@type":"Question","name":"Should I eat back calories burned from exercise?","acceptedAnswer":{"@type":"Answer","text":"If you selected an activity level that includes your regular exercise, don\'t eat back those calories. If you chose \"sedentary\" and do separate exercise, you can eat back 50-75% of estimated exercise calories to account for overestimation."}},{"@type":"Question","name":"What if I\'m not losing weight with a calorie deficit?","acceptedAnswer":{"@type":"Answer","text":"If you\'re not losing weight after 3-4 weeks, you\'re likely not in a true deficit. Common causes include underestimating food intake, overestimating activity level, or metabolic adaptation. Try reducing intake by 100-200 calories, improving tracking accuracy, or increasing activity."}},{"@type":"Question","name":"Is it safe to eat less than my BMR?","acceptedAnswer":{"@type":"Answer","text":"Generally, no. Eating below your BMR for extended periods can slow metabolism, cause muscle loss, hormonal imbalances, and nutrient deficiencies. Always maintain a minimum of 1,200 calories for women and 1,500 for men unless under medical supervision."}},{"@type":"Question","name":"Do I need to count calories forever?","acceptedAnswer":{"@type":"Answer","text":"Not necessarily. Calorie counting is a tool for awareness and achieving specific goals. Many people track for a few months to learn portion sizes and food values, then maintain their weight intuitively. Some prefer continued tracking for accountability."}},{"@type":"Question","name":"Which BMR formula should I use?","acceptedAnswer":{"@type":"Answer","text":"For most people, the Mifflin-St Jeor equation is recommended as it\'s the most accurate for the general population. Use Katch-McArdle if you know your body fat percentage and have above-average muscle mass. Harris-Benedict is older and slightly less accurate but still widely used."}},{"@type":"Question","name":"Can I lose fat and gain muscle at the same time?","acceptedAnswer":{"@type":"Answer","text":"Yes, but it\'s challenging and typically works best for beginners or those returning after a break (often called \"newbie gains\"). It requires a small calorie deficit, high protein intake (2g per kg body weight), and progressive resistance training. Most advanced trainees need separate bulking and cutting phases."}},{"@type":"Question","name":"How often should I recalculate my calorie needs?","acceptedAnswer":{"@type":"Answer","text":"Recalculate every 10-15 pounds of weight change, or every 2-3 months if maintaining weight. Your calorie needs decrease as you lose weight and increase as you gain weight, so regular adjustments are necessary for continued progress."}}]}' }}
      />
      <Navigation />
