  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is a healthy BMI range?","acceptedAnswer":{"@type":"Answer","text":"For adults 20 years and older, a healthy BMI range is 18.5 to 24.9 kg/m². This range is associated with the lowest health risks according to WHO guidelines. However, optimal BMI may vary slightly based on ethnicity, age, and individual health factors."}},{"@type":"Question","name":"Can BMI be inaccurate?","acceptedAnswer":{"@type":"Answer","text":"Yes, BMI has limitations. It doesn\'t distinguish muscle from fat, so athletes may be classified as overweight despite being healthy. It also doesn\'t account for age, sex, bone density, or fat distribution. BMI should be used alongside other health indicators like waist circumference, blood pressure, and cholesterol levels."}},{"@type":"Question","name":"How often should I check my BMI?","acceptedAnswer":{"@type":"Answer","text":"For most adults, checking BMI quarterly (every 3 months) is sufficient to monitor weight trends. If you\'re actively working on weight loss or gain, monthly checks can help track progress. Focus on long-term trends rather than daily or weekly fluctuations, which are normal."}},{"@type":"Question","name":"Is BMI different for men and women?","acceptedAnswer":{"@type":"Answer","text":"The BMI formula is the same for both sexes, but women typically have more body fat than men at the same BMI due to biological differences. The standard BMI categories apply to both, though some health organizations suggest women may have slightly different optimal ranges. Always consult healthcare providers for personalized assessment."}},{"@type":"Question","name":"How do I calculate BMI manually?","acceptedAnswer":{"@type":"Answer","text":"For metric: Divide your weight in kilograms by your height in meters squared (BMI = kg ÷ m²). For imperial: Multiply your weight in pounds by 703, then divide by your height in inches squared (BMI = 703 × lbs ÷ in²). Example: 70 kg ÷ (1.75 m)² = 70 ÷ 3.0625 = 22.86 kg/m²."}},{"@type":"Question","name":"What BMI is considered obese?","acceptedAnswer":{"@type":"Answer","text":"A BMI of 30 or higher is classified as obese. Obesity is further divided into: Class I (30-34.9), Class II (35-39.9), and Class III (40+), with health risks increasing at higher classes. Class III obesity, also called severe or morbid obesity, carries the highest health risks and may require medical intervention."}},{"@type":"Question","name":"Should children use the same BMI chart as adults?","acceptedAnswer":{"@type":"Answer","text":"No. Children and teens (ages 2-20) should use BMI-for-age percentile charts from the CDC, which account for normal growth patterns. The same BMI means different things at different ages for kids. Always consult a pediatrician for children\'s BMI interpretation and never put children on restrictive diets without medical supervision."}},{"@type":"Question","name":"Can BMI affect life insurance rates?","acceptedAnswer":{"@type":"Answer","text":"Yes, many life insurance companies use BMI as part of their underwriting process. Very high or very low BMIs may result in higher premiums or policy restrictions because they\'re associated with increased health risks. However, insurers typically consider BMI alongside other health factors like blood pressure, cholesterol, and medical history."}}]}' }}
      />
      <Navigation />
