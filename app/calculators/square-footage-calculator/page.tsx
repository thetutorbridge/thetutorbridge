  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I calculate square footage of a room?","acceptedAnswer":{"@type":"Answer","text":"Measure the length and width of the room in feet using a tape measure. Multiply length × width to get square feet. For example: a room that is 12 feet long and 10 feet wide is 12 × 10 = 120 square feet. For irregular rooms, divide into rectangles, calculate each section, then add them together."}},{"@type":"Question","name":"What is waste factor and why do I need it?","acceptedAnswer":{"@type":"Answer","text":"Waste factor accounts for material lost during cutting, fitting, breakage, and imperfect installations. Recommended percentages: tile 10-15% (complex patterns need more), hardwood/laminate 5-10%, carpet 5-10%, paint 10-20%, roofing 10-15%. Without waste factor, you\'ll run short and face delays waiting for additional materials."}},{"@type":"Question","name":"How many square feet are in a square yard?","acceptedAnswer":{"@type":"Answer","text":"1 square yard = 9 square feet. Since 1 yard = 3 feet, when you square both sides: (1 yd)² = (3 ft)², so 1 sq yd = 9 sq ft. Carpet is often sold by the square yard. To convert: divide square feet by 9. Example: 180 sq ft ÷ 9 = 20 square yards of carpet."}},{"@type":"Question","name":"Can I mix different units of measurement?","acceptedAnswer":{"@type":"Answer","text":"Yes! Our calculator allows you to enter length in one unit (e.g., feet) and width in another (e.g., inches), and it automatically converts to calculate accurate square footage. For example: length = 12 feet, width = 18 inches → the calculator converts 18 inches to 1.5 feet, then calculates 12 × 1.5 = 18 sq ft."}},{"@type":"Question","name":"How do I measure square footage for flooring?","acceptedAnswer":{"@type":"Answer","text":"Step 1: Measure room length and width at the widest points (walls aren\'t always perfectly straight). Step 2: Multiply for square footage. Step 3: Add 5-15% waste factor depending on material and pattern. Step 4: For multiple rooms, calculate each separately then add together. Always round up when ordering materials."}},{"@type":"Question","name":"What if my room has closets or alcoves?","acceptedAnswer":{"@type":"Answer","text":"Method 1 (Subtract): Calculate the main room area, then calculate closet/alcove areas separately and subtract. Method 2 (Add): Divide room into rectangles (main room + closet), calculate each, add together. For flooring/carpet, include closet areas. For painting, calculate walls separately - alcoves add perimeter."}},{"@type":"Question","name":"How much paint do I need per square foot?","acceptedAnswer":{"@type":"Answer","text":"One gallon of paint typically covers 350-400 square feet of smooth wall with one coat. Textured walls, porous surfaces, or dark-to-light color changes require more. Formula: (Total sq ft ÷ 350) × number of coats = gallons needed. Always add 10-20% for touchups and waste. Example: 400 sq ft wall, 2 coats → (400 ÷ 350) × 2 = 2.3 gallons → buy 3 gallons."}},{"@type":"Question","name":"How do I convert square feet to acres?","acceptedAnswer":{"@type":"Answer","text":"1 acre = 43,560 square feet. To convert sq ft to acres: divide by 43,560. Example: 10,000 sq ft ÷ 43,560 = 0.2296 acres (about ¼ acre). To convert acres to sq ft: multiply by 43,560. Example: 0.5 acres × 43,560 = 21,780 sq ft. Our calculator shows both automatically."}}]}' }}
      />
      <Navigation />
