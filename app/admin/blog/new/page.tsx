              ...
              <CardContent>
                ...
                {formData.title && (
                  <p className="text-sm text-gray-500 mt-2">
                    Generated slug: {isClient ? generatedSlug : 'Generating...'}
                  </p>
                )}
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{isClient ? `${estimatedReadTime} minutes` : 'Calculating...'}</p>
                  </div>
                  <div>
