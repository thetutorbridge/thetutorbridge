      ...
      <div className="bg-gray-50 py-4 px-6">
        <div className="container mx-auto max-w-7xl">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-600">CSS Minifier</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600">
              Minify CSS code - Free CSS minifier
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div>
                <label className="block text-lg font-semibold text-gray-900 mb-3">CSS Input</label>
                <textarea
                  value={css}
              ...
              <div>
                <div className="flex justify-between items-center mb-3">
                  <label className="block text-lg font-semibold text-gray-900">Minified CSS</label>
                  {minified && (
            ...
            {minified && (
              <div className="mt-4 text-sm text-gray-600">
                <p>Original: {css.length} characters | Minified: {minified.length} characters | Saved: {((1 - minified.length / css.length) * 100).toFixed(1)}%</p>
              </div>
            )}
          </div>
        </div>
