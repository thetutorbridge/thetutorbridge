      ...
      <div className="bg-gray-50 py-4 px-6">
        <div className="container mx-auto max-w-7xl">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-600">SQL Formatter</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-4">
              <Database className="w-12 h-12 mr-3 text-[#2BAE66]" />
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900">
                SQL Formatter
              </h1>
            </div>
            <p className="text-xl text-gray-600">
              Format SQL queries - Free SQL formatter
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div>
                <label className="block text-lg font-semibold text-gray-900 mb-3">SQL Input</label>
                <textarea
                  value={sql}
              ...
              <div>
                <label className="block text-lg font-semibold text-gray-900 mb-3">Formatted SQL</label>
                <textarea
                  value={formatted}
                  readOnly
