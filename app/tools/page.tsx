...
import { Home, Clock, Type, Lock, Dices, CaseSensitive, ArrowRight, Zap, Shield, Sparkles, Calendar, DollarSign, Thermometer, FileText, Ruler, User, Hash, Code, Palette, Globe, Repeat, ArrowLeftRight, FileJson, Key, Link as LinkIcon, Code2, QrCode, Percent, HeartPulse, Tag, Scale, Calculator, Timer, GitCompare, FileCode, FileSpreadsheet, Binary, Hash as HashIcon, Clock as ClockIcon, Palette as PaletteIcon, Box, Minimize, Database, Image, Barcode, BarChart3, Search, Table, Radio, Eraser, Shuffle, BarChart, ArrowUpDown, Layers, Space } from 'lucide-react';
...
const tools = [
...
];
  {
    ...
    icon: BarChart3,
    description: 'Analyze text with detailed statistics. Count characters, words, sentences, paragraphs, reading time, and more.',
    color: 'from-blue-500 to-blue-600',
    traffic: '800k+',
    features: ['Character Count', 'Word Count', 'Reading Time', 'Word Frequency'],
  },
  {
    name: 'Regex Tester',
    slug: 'regex-tester',
    icon: Search,
    description: 'Test regular expressions with real-time matching. Perfect for developers working with pattern matching.',
    color: 'from-purple-500 to-purple-600',
    traffic: '1M+',
    features: ['Real-time Matching', 'Flags Support', 'Match Highlighting', 'Match List'],
  },
  {
    name: 'JSON to XML',
    slug: 'json-to-xml',
    icon: FileCode,
    description: 'Convert JSON data to XML format instantly. Perfect for data transformation and API integration.',
    color: 'from-green-500 to-green-600',
    traffic: '700k+',
    features: ['JSON Parser', 'XML Output', 'Copy Code', 'Error Handling'],
  },
  {
    name: 'JSON to CSV',
    slug: 'json-to-csv-converter',
    icon: FileSpreadsheet,
    description: 'Convert JSON arrays to CSV format. Perfect for data export and spreadsheet import.',
    color: 'from-teal-500 to-teal-600',
    traffic: '900k+',
    features: ['Array Parser', 'CSV Output', 'Headers Support', 'Copy CSV'],
  },
  {
    name: 'HTML Table Generator',
    slug: 'html-table-generator',
    icon: Table,
    description: 'Generate HTML tables with custom rows and columns. Includes header option and live preview.',
    color: 'from-orange-500 to-orange-600',
    traffic: '600k+',
    features: ['Custom Size', 'Header Option', 'HTML Code', 'Live Preview'],
  },
  {
    name: 'Markdown Table Generator',
    slug: 'markdown-table-generator',
    icon: Table,
    description: 'Create markdown tables for GitHub and documentation. Custom rows and columns support.',
    color: 'from-pink-500 to-pink-600',
    traffic: '500k+',
    features: ['Custom Size', 'Markdown Syntax', 'Copy Code', 'GitHub Ready'],
  },
  {
    name: 'HTML Beautifier',
    slug: 'html-beautifier',
    icon: Code,
    description: 'Format and beautify HTML code with proper indentation. Perfect for code formatting.',
    color: 'from-red-500 to-red-600',
    traffic: '800k+',
    features: ['Format HTML', 'Indentation', 'Copy Code', 'Error Handling'],
  },
  {
    name: 'CSS Beautifier',
    slug: 'css-beautifier',
    icon: Code,
    description: 'Format and beautify CSS code with proper indentation. Clean up minified CSS.',
    color: 'from-indigo-500 to-indigo-600',
    traffic: '700k+',
    features: ['Format CSS', 'Indentation', 'Copy Code', 'Clean Output'],
  },
  {
    name: 'JS Beautifier',
    slug: 'js-beautifier',
    icon: Code,
    description: 'Format and beautify JavaScript code. Make minified code readable again.',
    color: 'from-yellow-500 to-yellow-600',
    traffic: '900k+',
    features: ['Format JS', 'Indentation', 'Copy Code', 'Readable Output'],
  },
  {
    name: 'Color Shades Generator',
    slug: 'color-shades-generator',
    icon: PaletteIcon,
    description: 'Generate lighter and darker shades of any color. Perfect for UI design and color schemes.',
    color: 'from-fuchsia-500 to-fuchsia-600',
    traffic: '800k+',
    features: ['11 Shades', 'Color Picker', 'Copy Colors', 'Design Tool'],
  },
  {
    name: 'Morse Code Translator',
    slug: 'morse-code-translator',
    icon: Radio,
    description: 'Translate text to and from Morse code. Bidirectional conversion support.',
    color: 'from-cyan-500 to-cyan-600',
    traffic: '600k+',
    features: ['To Morse', 'From Morse', 'Instant Convert', 'Full Alphabet'],
  },
  {
    ...
    color: 'from-lime-500 to-lime-600',
    traffic: '700k+',
    features: ['4 Number Bases', 'Instant Convert', 'Copy Output', 'Error Free'],
  },
  {
    name: 'Scientific Calculator',
    slug: 'scientific-calculator',
    icon: Calculator,
    description: 'Advanced scientific calculator with trigonometry, logarithms, and more mathematical functions.',
    color: 'from-blue-500 to-blue-600',
    traffic: '2M+',
    features: ['Scientific Functions', 'Trig Functions', 'Logarithms', 'Square Root'],
  },
  {
    name: 'Find and Replace',
    slug: 'find-and-replace',
    icon: Search,
    description: 'Find and replace text in bulk. Replace all occurrences instantly.',
    color: 'from-green-500 to-green-600',
    traffic: '800k+',
    features: ['Bulk Replace', 'Instant Results', 'Copy Output', 'Simple UI'],
  },
  {
    name: 'Text Cleaner',
    slug: 'text-cleaner',
    icon: Eraser,
    description: 'Clean and format text by removing extra whitespace and normalizing line breaks.',
    color: 'from-purple-500 to-purple-600',
    traffic: '600k+',
    features: ['Remove Spaces', 'Clean Lines', 'Format Text', 'Copy Output'],
  },
  {
    name: 'List Randomizer',
    slug: 'list-randomizer',
    icon: Shuffle,
    description: 'Randomize list order. Perfect for shuffling lists and creating random orders.',
    color: 'from-orange-500 to-orange-600',
    traffic: '500k+',
    features: ['Shuffle List', 'Instant Random', 'Copy Output', 'Line by Line'],
  },
  {
    name: 'Word Frequency Counter',
    slug: 'word-frequency-counter',
    icon: BarChart,
    description: 'Count word frequencies in text. See top 20 most common words with counts.',
    color: 'from-teal-500 to-teal-600',
    traffic: '700k+',
    features: ['Word Count', 'Top 20 Words', 'Frequency Stats', 'Sorted List'],
  },
  {
    name: 'Character Frequency Counter',
    slug: 'character-frequency-counter',
    icon: BarChart,
    description: 'Count character frequencies in text. Analyze character usage patterns.',
    color: 'from-pink-500 to-pink-600',
    traffic: '600k+',
    features: ['Character Count', 'Top 20 Chars', 'Frequency Stats', 'Sorted List'],
  },
  {
    name: 'RGB to HSL Converter',
    slug: 'rgb-hsl-converter',
    icon: PaletteIcon,
    description: 'Convert RGB colors to HSL format. Perfect for color manipulation and design.',
    color: 'from-red-500 to-red-600',
    traffic: '600k+',
    features: ['RGB Input', 'HSL Output', 'Instant Convert', 'Color Preview'],
  },
  {
    name: 'Random Color Generator',
    slug: 'random-color-generator',
    icon: PaletteIcon,
    description: 'Generate 10 random colors with HEX codes. Perfect for design inspiration.',
    color: 'from-indigo-500 to-indigo-600',
    traffic: '700k+',
    features: ['10 Colors', 'HEX Codes', 'Click to Copy', 'Color Preview'],
  },
  {
    name: 'Decimal to Binary',
    slug: 'decimal-binary-converter',
    icon: Binary,
    description: 'Convert between decimal and binary numbers. Bidirectional conversion.',
    color: 'from-yellow-500 to-yellow-600',
    traffic: '600k+',
    features: ['Decimal to Binary', 'Binary to Decimal', 'Instant Convert', 'Copy Output'],
  },
  {
    name: 'ASCII Text Generator',
    slug: 'ascii-text-generator',
    icon: Type,
    description: 'Generate ASCII art text. Create large text banners from regular text.',
    color: 'from-cyan-500 to-cyan-600',
    traffic: '800k+',
    features: ['ASCII Art', 'Text Banner', 'Copy Output', 'Monospace Font'],
  },
  {
    name: 'Line Sorter',
    slug: 'line-sorter',
    ...
    color: 'from-lime-500 to-lime-600',
    traffic: '500k+',
    features: ['Sort A-Z', 'Sort Z-A', 'Line by Line', 'Copy Output'],
  },
  {
    name: 'List Deduplicator',
    slug: 'list-deduplicator',
    icon: Layers,
    description: 'Remove duplicate lines from lists. Keep only unique entries.',
    color: 'from-fuchsia-500 to-fuchsia-600',
    traffic: '500k+',
    features: ['Remove Duplicates', 'Keep Unique', 'Line by Line', 'Copy Output'],
  },
  {
    name: 'Whitespace Remover',
    slug: 'whitespace-remover',
    icon: Space,
    description: 'Remove extra whitespace from text. Clean up formatting issues.',
    color: 'from-blue-500 to-blue-600',
    traffic: '400k+',
