...
export const metadata: Metadata = {
  title: "Math Tutoring Online | Algebra, Geometry, Calculus | Grades 6-12 | The Tutor Bridge",
  description: "Expert 1-on-1 online math tutoring for middle school and high school. Algebra, Geometry, Pre-Calculus, Calculus, Statistics. U.S.-certified math tutors. Free consultation.",
  keywords: [
    "math tutor",
  ...
  alternates: {
    canonical: "https://www.thetutorbridge.com/tutoring/math",
  },
  openGraph: {
    title: "Math Tutoring Online | Algebra, Geometry, Calculus | Grades 6-12",
    description: "Expert 1-on-1 online math tutoring with U.S.-certified tutors. Free consultation available.",
    url: "https://www.thetutorbridge.com/tutoring/math",
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
                Weekly 1-on-1 sessions with expert math tutors. From pre-algebra to AP Calculus, we help students master math and build lasting confidence.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <Link href="/tutoring/free-consultation">
                  <Button size="lg" className="bg-[#1A3D7C] text-white rounded-xl px-8 py-4 hover:bg-[#1A3D7C]/90 transition-all font-semibold w-full sm:w-auto">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-poppins font-bold text-[#1A3D7C] mb-4">
                Math Topics We Tutor
              </h2>
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                Comprehensive math tutoring for every level, aligned with Common Core and AP standards.
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {[
                { title: "Pre-Algebra & Algebra 1", topics: ["Variables & Expressions", "Linear Equations", "Inequalities", "Graphing"] },
                { title: "Algebra 2", topics: ["Quadratics", "Polynomials", "Exponentials", "Logarithms"] },
                { title: "Geometry", topics: ["Proofs", "Triangles", "Circles", "Coordinate Geometry"] },
                { title: "Pre-Calc & Calculus", topics: ["Functions", "Limits", "Derivatives", "Integrals"] },
              ].map((item, index) => (
                <Card key={index} className="p-6">
                  <CardContent className="p-0">
                    <h3 className="font-poppins font-bold text-[#1A3D7C] mb-3">{item.title}</h3>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <Card className="p-6 text-center">
                <CardContent className="p-0">
                  ...
                  <h3 className="font-poppins font-bold text-[#1A3D7C] mb-2">Same Tutor Every Week</h3>
                  <p className="text-gray-600 text-sm">Build a relationship with a tutor who knows your learning style and tracks your progress.</p>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 text-center">
                <CardContent className="p-0">
                  ...
                  <h3 className="font-poppins font-bold text-[#1A3D7C] mb-2">Personalized Curriculum</h3>
                  <p className="text-gray-600 text-sm">Lessons tailored to your school's curriculum and your specific areas of improvement.</p>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 text-center">
                <CardContent className="p-0">
                  ...
                  <h3 className="font-poppins font-bold text-[#1A3D7C] mb-2">Proven Results</h3>
                  <p className="text-gray-600 text-sm">95% of our math students improve by at least one letter grade within 3 months.</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <section className="py-16 sm:py-20 bg-gradient-to-r from-[#1A3D7C] to-[#2BAE66] text-white">
          <div className="container mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
              Book a free consultation and get matched with the perfect math tutor for your child.
            </p>
            <Link href="/tutoring/free-consultation">
