      ...
      <section className="bg-gradient-to-br from-[#1A3D7C] to-[#2BAE66] text-white py-16 px-6">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-8">
            Access comprehensive study materials, practice questions, and learning guides for Class 11 subjects.
          </p>
                    ...
                    {subject === "Science" ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 mb-6 max-w-md mx-auto">
                          Access comprehensive Class 11 Science resources including Chapter 1: The Wonderful World of Science.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-3 justify-center">
                          <Link href="/study-resources/class-11/science/chapter-1-the-wonderful-world-of-science">
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 mb-6 max-w-md mx-auto">
                          We're working hard to bring you comprehensive {subject.toLowerCase()} resources for Class 11. 
      ...
      <section className="py-16 bg-gradient-to-r from-[#1A3D7C] to-[#2BAE66] text-white px-6">
        <div className="container mx-auto text-center max-w-4xl">
          <h2 className="text-2xl md:text-3xl font-poppins font-bold mb-6">
            Need Help with Class 11 Studies?
          </h2>
          <p className="text-lg md:text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Our expert mentors can help you understand concepts better and excel in your Class 11 studies.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/tutoring/free-consultation">
              <Button size="lg" className="bg-[#FFC857] text-[#1A3D7C] rounded-xl px-8 py-4 hover:shadow-lg hover:bg-[#FFC857]/90 transition-all text-lg font-semibold">
