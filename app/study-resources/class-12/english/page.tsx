...
export const metadata: Metadata = {
  title: 'Class 12 English Study Resources – Complete Chapter-wise Notes & Study Materials',
  description: 'Get comprehensive Class 12 english study resources covering all chapters. Complete English study materials including literature, grammar, writing skills, and comprehension. Free notes, explanations, and practice questions.',
};

export default function Class12EnglishPage() {
  const chapters = [
    // TODO: Add specific chapters for Class 12 english
      ...
      <section className="bg-gradient-to-br from-[#1A3D7C] to-[#2BAE66] text-white py-16 px-6">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-8">
            Master Class 12 English with comprehensive study materials covering all chapters. Build strong foundations for academic success.
          </p>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-[#1A3D7C] to-[#2BAE66] text-white p-8 rounded-2xl text-center">
              <h2 className="text-2xl font-bold mb-4">
                📚 Class 12 English Content Coming Soon!
              </h2>
              <p className="text-lg mb-6 opacity-90">
                We're working hard to bring you comprehensive Class 12 english study materials. 
          ...
          <section className="text-center py-12">
            <div className="bg-gradient-to-r from-[#1A3D7C] to-[#2BAE66] text-white p-8 rounded-2xl">
              ...
              <p className="text-lg mb-6 opacity-90">
                Our expert english tutors can help you master all Class 12 topics with personalized guidance and interactive learning.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/tutoring/free-consultation">
                  <button className="bg-[#FFC857] text-[#1A3D7C] px-8 py-3 rounded-xl font-semibold hover:bg-[#FFC857]/90 transition-colors">
